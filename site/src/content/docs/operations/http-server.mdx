...
| HTTP, eight live credentials             |   113 to 267 MiB | Peaks of 208 to 647 MiB while all eight were calling              |
| HTTP, a hundred credentials, all calling |   0.5 to 2.0 GiB | Measured by the concurrency series, one process per surface       |
