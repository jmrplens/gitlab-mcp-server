...
| `--meta-tools`           | `true`                       | Enable domain meta-tools. Set `false` for individual tools                                                                                |
| `--tool-surface`         | _(empty)_                    | Explicit tool catalog selector; see [Tool and capability surface options](#tool-and-capability-surface-options). Overrides `--meta-tools` |
