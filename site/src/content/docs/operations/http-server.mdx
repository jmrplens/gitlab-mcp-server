...
:::tip
Pin the image to a specific version (e.g. `ghcr.io/jmrplens/gitlab-mcp-server:1.4.1`) in production. The `latest` tag tracks the newest release and may shift unexpectedly.
:::
