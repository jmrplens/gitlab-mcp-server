...
flowchart TD
    ...
    J -->|No| J2[Set GITLAB_MCP_SKIP_TLS_VERIFY=true<br/>as last resort]
...
:::caution
`GITLAB_MCP_SKIP_TLS_VERIFY=true` disables TLS verification entirely. Use it only for self-hosted instances with self-signed certificates, and never in production environments with public-facing GitLab instances.
:::
