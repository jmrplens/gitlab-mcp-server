...
| Symptom                                   | Cause                    | Solution                                                                                        |
| ----------------------------------------- | ------------------------ | ----------------------------------------------------------------------------------------------- |
| MCP client shows 1004 tools instead of 40 | Meta-tools disabled      | Set `META_TOOLS=true` (default) to consolidate into domain meta-tools                           |
...
| Enterprise tools missing                  | Enterprise mode disabled | Set `GITLAB_ENTERPRISE=true` to enable 19 additional enterprise meta-tools                      |
