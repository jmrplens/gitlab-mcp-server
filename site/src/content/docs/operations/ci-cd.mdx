...
| -------------------------- | ------------------------------------------------------ | -------------------------------- |
| `gitlab_ci_lint`           | `validate`, `project_lint`                             | Validate `.gitlab-ci.yml` syntax |
| `gitlab_ci_variable`       | `list`, `get`, `create`, `update`, `delete`            | Manage CI/CD variables           |
| `gitlab_pipeline_schedule` | `list`, `get`, `create`, `update`, `delete`, `trigger` | Manage scheduled pipelines       |
| `gitlab_environment`       | `list`, `get`, `create`, `update`, `delete`, `stop`    | Manage environments              |
| `gitlab_deployment`        | `list`, `get`                                          | Track deployments                |
