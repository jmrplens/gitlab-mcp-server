...
| `schedule_*_variable` | Schedule variable CRUD (create, edit, delete); same prefix on the dynamic surface                                                                             |
...
| `download_artifacts` | Download a job's artifacts archive                                         |
...
| `x509: certificate signed by unknown authority` | Set `GITLAB_MCP_SKIP_TLS_VERIFY=true`                           |
...
For the complete technical reference, see [`docs/guides/ci-cd.md`](https://github.com/jmrplens/gitlab-mcp-server/blob/main/docs/guides/ci-cd.md) in the repository.
:::
