...
sequenceDiagram
    ...
    S-->>AI: Progress: "Read 1048576 / 5242880 bytes, preparing the upload"
    S-->>AI: Progress: "Read 5242880 bytes, uploading to GitLab"
