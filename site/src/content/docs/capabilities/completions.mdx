---
title: Completions
description: MCP argument completions that suggest GitLab projects, branches, users, and labels while composing tool parameters.
---
...
The server supports **{stats.completions} completion argument types** organized into global and per-project completers:
