...
| [Subscriptions](/gitlab-mcp-server/capabilities/subscriptions/) | Client → Server (updates Server → Client) | Live change notifications for 26 GitLab resource kinds, honored by polling (`GITLAB_MCP_CAPABILITY_SURFACE=full` only) |
