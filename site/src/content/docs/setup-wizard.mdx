---
title: Setup Wizard
description: Install and configure GitLab MCP Server for stdio MCP clients using the built-in Web, TUI, or CLI setup wizard — no JSON editing required.
---
...
Regardless of the UI mode you pick, the wizard runs the same five steps:
...
| Enterprise/Premium catalog | `GITLAB_TIER`            | Sets the edition (`free`/`premium`/`ultimate`) that gates Premium/Ultimate tools in stdio mode. |
