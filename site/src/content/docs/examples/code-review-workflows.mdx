...
```
gitlab_merge_request → action: changes, project_id: "my-group/backend", mr_iid: 42
```
...
gitlab_merge_request → action: note_create, project_id: "my-group/backend",
  mr_iid: 42, body: "The error handling in auth.go needs a retry mechanism"
```
...
gitlab_merge_request → action: discussion_create, project_id: "my-group/backend",
  mr_iid: 42, body: "Let's discuss the database migration strategy..."
```
...
gitlab_merge_request → action: draft_note_create, project_id: "my-group/backend",
  mr_iid: 42, note: "Consider using a context timeout here..."
```
