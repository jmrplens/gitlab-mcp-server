...
description: "Issue management examples with GitLab MCP Server: triage open issues, assign and label, link related issues, track milestones, discuss, and search across projects."
---
