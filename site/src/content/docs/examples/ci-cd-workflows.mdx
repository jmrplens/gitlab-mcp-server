...
:::tip
All CI/CD examples use meta-tool mode with `TOOL_SURFACE=meta`. The AI assistant maps your natural language request to the correct `action` parameter automatically.
:::
