...
gitlab_execute_tool → action: "merge_request.list", params: { project_id: "42", state: "opened" }
```
...
gitlab_execute_tool → action: "analyze.pipeline_failure", params: { project_id: "42", pipeline_id: 12345 }
```
