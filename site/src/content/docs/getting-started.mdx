...
Pair dynamic mode with `CAPABILITY_SURFACE=minimal` to keep only workspace roots and omit optional resources and prompts when you need the smallest initial MCP context.
:::
