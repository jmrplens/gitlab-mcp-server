...
By default, the server runs in **meta-tool mode** — instead of registering 1005 individual tools (which would consume most of the LLM's context window), it consolidates them into **28 domain-level meta-tools** (43 with enterprise) that cover 100% of the functionality.
