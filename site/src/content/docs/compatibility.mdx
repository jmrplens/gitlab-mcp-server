...
| ----------- | :-----------------------------------------------------------------------: |
| Tools       | ✅ (up to 1031 individual / 33 base, 49 self-managed, 50 GitLab.com meta) |
| Resources   |                                  ✅ (46)                                  |
| Prompts     |                                  ✅ (37)                                  |
...
The 1031 individual figure is the expanded set of distinct tool instances. The 33 base, 49 self-managed, and 50 GitLab.com counts are meta-tool catalog sizes whose actions expand to that larger individual tool surface.
