...
GitLab MCP Server works with both Community Edition (CE) and Enterprise Edition (EE). The `GITLAB_ENTERPRISE` environment variable unlocks 19 additional enterprise-only meta-tools.
