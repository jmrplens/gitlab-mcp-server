...
| ----------- | :-----------------------------------------------------------------------: |
| Tools       | ✅ (up to 1011 individual / 33 base, 47 self-managed, 48 GitLab.com meta) |
| Resources   |                                  ✅ (46)                                  |
| Prompts     |                                  ✅ (38)                                  |
...
The 1011 individual figure is the expanded set of distinct tool instances. The 33 base, 47 self-managed, and 48 GitLab.com counts are meta-tool catalog sizes whose actions expand to that larger individual tool surface.
