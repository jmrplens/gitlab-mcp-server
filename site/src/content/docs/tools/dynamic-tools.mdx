...
Large MCP servers can spend a lot of context on tool discovery before the user asks anything. GitLab MCP Server can expose up to 1034 individual operations on GitLab.com Enterprise/Premium with Orbit, and the optional meta-tool catalog advertises 32 to 49 domain tools.
...
| -------------------------------- | ------------------------------------ | --------------------------------------------- |
| What is visible in `tools/list`? | 32 to 49 domain tools                | 2 public discovery/execution tools            |
