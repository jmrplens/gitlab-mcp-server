...
Large MCP servers can spend a lot of context on tool discovery before the user asks anything. GitLab MCP Server can expose up to 1011 individual operations, and even the default meta-tool catalog advertises 33 to 48 domain tools.
...
| -------------------------------- | --------------------------------------------------- | ------------------------------------------------------------- |
| What is visible in `tools/list`? | 33 to 48 domain tools                               | 3 public discovery/execution tools                            |
