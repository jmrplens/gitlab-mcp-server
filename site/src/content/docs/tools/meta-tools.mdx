---
title: Meta-tools
description: Meta-tools group related GitLab operations into domain-level MCP tools that route on an action parameter, cutting tool count 95%+ while keeping full functionality.
head:
  - tag: script
    attrs:
