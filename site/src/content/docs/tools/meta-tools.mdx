...
| -------------------- | -------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `META_TOOLS`         | `true`   | Tool catalog selector: `true` for meta-tools, `false` for individual tools, `dynamic` for the low-token dynamic surface, or experimental `dynamic-2`/`dynamic-3` surfaces.                 |
