...
The server exposes **44 resources** across several categories:
...
| `gitlab://project/{project_id}/mr/{mr_iid}/notes`       | Notes on a merge request                                                    |
| `gitlab://project/{project_id}/mr/{mr_iid}/discussions` | Discussion threads on a merge request                                       |
