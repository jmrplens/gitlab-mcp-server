...
| Meta-tool            | Description                 | Key Actions                                                  |
| -------------------- | --------------------------- | ------------------------------------------------------------ |
| `gitlab_pipeline`    | Pipeline management         | list, get, create, cancel, retry, delete, wait, schedule\_\* |
...
| `gitlab_environment` | Environment management      | list, get, create, update, delete, stop, deployment\_\*      |
