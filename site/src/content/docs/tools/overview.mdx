...
| Meta-tool                  | Description                 | Key Actions                                            |
| -------------------------- | --------------------------- | ------------------------------------------------------ |
| `gitlab_pipeline`          | Pipeline management         | list, get, create, cancel, retry, delete, wait, schedule_* |
...
| `gitlab_environment`       | Environment management      | list, get, create, update, delete, stop, deployment_*  |
