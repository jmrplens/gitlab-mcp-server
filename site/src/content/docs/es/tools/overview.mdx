...
| Meta-herramienta           | Descripción                    | Acciones principales                                   |
| -------------------------- | ------------------------------ | ------------------------------------------------------ |
| `gitlab_pipeline`          | Gestión de pipelines           | list, get, create, cancel, retry, delete, wait, schedule_* |
...
| `gitlab_environment`       | Gestión de entornos            | list, get, create, update, delete, stop, deployment_*  |
