...
description: Cómo GitLab MCP Server expone más de 1000 operaciones de GitLab a los asistentes de IA mediante tres modos de herramientas — dinámico, meta-herramientas e individual — que equilibran el coste de tokens con la granularidad.
head:
  - tag: script
    attrs:
