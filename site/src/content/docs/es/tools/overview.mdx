    ...
    content: |
      {
        ...
        "itemListElement": [
          ...
          },
          {
            ...
            "description": "Feature flags, registro de modelos, catálogo CI/CD, emoji personalizados y resolución de proyecto desde el remoto git: gitlab_feature_flags, gitlab_model_registry, gitlab_ci_catalog, gitlab_custom_emoji, gitlab_resolve_project.",
