...
En modo individual, el servidor registra **1005 herramientas individuales**, cada una mapeada a una sola operación de la API de GitLab. Esto proporciona la máxima granularidad pero consume una cantidad significativa de tokens de contexto del LLM para el descubrimiento de herramientas.
