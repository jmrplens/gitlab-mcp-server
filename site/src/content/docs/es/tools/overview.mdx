...
En modo individual, el servidor registra una herramienta por operación de GitLab: **863 herramientas** para CE, **1014 herramientas** para Enterprise/Premium autoalojado, o **1019 herramientas** en GitLab.com Enterprise/Premium cuando Orbit está disponible. Esto proporciona la máxima granularidad pero consume una cantidad significativa de tokens de contexto del LLM para el descubrimiento de herramientas.
