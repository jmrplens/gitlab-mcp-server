...
El servidor expone **46 recursos** en varias categorías:

:::note
MCP lista por separado los recursos fijos y las plantillas de URI. En modo full, los clientes que solo inspeccionan `resources/list` ven 9 URIs fijas: usuario actual, grupos, raíces del workspace, el manifiesto de herramientas y 5 guías de flujo. Las 37 entradas restantes son plantillas de URI devueltas por `resources/templates/list` y se leen sustituyendo IDs de proyecto, grupo, issue, MR u otros valores en tiempo de ejecución.
:::

### Recursos estáticos (4)
...
El servidor proporciona **37 plantillas de prompts** organizadas en categorías:
...
| -------------------- | -------------- | ----------------------------------------------------------------------------------------------------------------------- |
| `CAPABILITY_SURFACE` | `full`         | `full` registra recursos, guías, prompts y `gitlab://tools`; `minimal` mantiene raíces del workspace y `gitlab://tools` |
