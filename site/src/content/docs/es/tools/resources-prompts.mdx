...
| `gitlab://project/{project_id}/mr/{mr_iid}/notes`       | Notas en una merge request                                                    |
| `gitlab://project/{project_id}/mr/{mr_iid}/discussions` | Hilos de discusión en una merge request                                       |
