...
| -------------------- | -------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `META_TOOLS`         | `true`         | Selector del catálogo: `true` para meta-herramientas, `false` para herramientas individuales, o `dynamic` para la superficie dinámica de bajo consumo.                                                |
