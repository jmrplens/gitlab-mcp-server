...
| -------------------- | -------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `META_TOOLS`         | `true`         | Selector del catálogo: `true` para meta-herramientas, `false` para herramientas individuales, `dynamic` para la superficie dinámica de bajo consumo, `dynamic-3` para la superficie dinámica actual explícita, o `dynamic-2` experimental. |
