...
| -------------------- | -------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `META_TOOLS`         | `true`         | Selector del catálogo: `true` para meta-herramientas, `false` para herramientas individuales, `dynamic` para la superficie dinámica de bajo consumo, o superficies experimentales `dynamic-2`/`dynamic-3`. |
