...
Los LLMs tienen ventanas de contexto limitadas. Cuando un servidor MCP registra 1005 herramientas individuales, solo las descripciones de las herramientas consumen una gran porción de los tokens disponibles, dejando menos espacio para la conversación real.

| Modo              | Nº de herramientas | Overhead de tokens | Funcionalidad               |
| ----------------- | ------------------ | ------------------ | --------------------------- |
| Individual        | 1005               | Muy alto           | Completa                    |
