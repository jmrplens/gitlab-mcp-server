...
| ------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Dinámica predeterminada   | Usa `gitlab_find_action` para encontrar la acción canónica `analyze.*`, y luego llama a `gitlab_execute_tool` con ese ID de acción y parámetros validados |
