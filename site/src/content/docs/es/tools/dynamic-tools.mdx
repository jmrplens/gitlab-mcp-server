...
Los servidores MCP grandes pueden gastar mucho contexto solo en descubrimiento de herramientas antes de que el usuario pida nada. GitLab MCP Server puede exponer hasta 1022 operaciones individuales, y el catálogo opcional de meta-herramientas anuncia entre 33 y 50 herramientas de dominio.
...
| Dónde están los schemas     | Schema de herramienta o recursos `gitlab://schema/meta/...` | `gitlab_find_action`                                      |
