...
Los servidores MCP grandes pueden gastar mucho contexto solo en descubrimiento de herramientas antes de que el usuario pida nada. GitLab MCP Server puede exponer hasta 1011 operaciones individuales, e incluso el catálogo predeterminado de meta-herramientas anuncia entre 33 y 48 herramientas de dominio.
...
| --------------------------- | ----------------------------------------------------------- | --------------------------------------------------------------------- |
| Qué aparece en `tools/list` | 33 a 48 herramientas de dominio                             | 3 herramientas públicas de descubrimiento y ejecución                 |
