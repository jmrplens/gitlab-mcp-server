...
description: Instala y configura GitLab MCP Server para clientes MCP stdio con el asistente integrado Web, TUI o CLI — sin editar JSON.
---
...
Independientemente del modo de interfaz que elijas, el asistente ejecuta los mismos cinco pasos:
...
| Catálogo Enterprise/Premium      | `GITLAB_TIER`            | Define la edición (`free`/`premium`/`ultimate`) que habilita las herramientas Premium/Ultimate en modo stdio. |
