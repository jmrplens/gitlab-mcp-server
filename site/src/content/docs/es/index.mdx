...
| **Conjunto dinámico**           | Modo opcional de bajo consumo con 3 herramientas: buscar en el registro oculto, describir schemas exactos y ejecutar acciones canónicas        |
