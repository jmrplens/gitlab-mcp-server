...
description: Servidor MCP con hasta 1019 herramientas GitLab, 33/49/50 meta-herramientas, recursos, prompts y transportes stdio/HTTP
hero:
  tagline: Conecta tu asistente de IA a GitLab con hasta 1019 herramientas mediante el Model Context Protocol
  image:
...
| ------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------- |
| **33/49/50 Meta-herramientas**  | Herramientas agrupadas por dominio que cubren proyectos, issues, merge requests, pipelines, CI/CD, wikis, releases, Orbit y más                |
| **Conjunto dinámico**           | Modo opcional de bajo consumo con 3 herramientas: buscar en el catálogo canónico, describir schemas exactos y ejecutar acciones canónicas      |
...
| **Herramientas Enterprise**     | Catálogo Premium/Ultimate opcional: 15 meta-herramientas autoalojadas, más Orbit Knowledge Graph solo en GitLab.com                            |
...
<CardGrid>
	...
	<LinkCard
		...
		description="Usa el modo de bajo consumo para buscar, describir y ejecutar"
	/>
</CardGrid>
