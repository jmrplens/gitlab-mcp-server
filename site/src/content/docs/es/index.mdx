...
description: Servidor MCP con hasta 1030 (1036 en GitLab.com Enterprise/Premium) herramientas GitLab, 33/49/50 meta-herramientas, recursos, prompts y transportes stdio/HTTP
hero:
  tagline: Hasta 1036 herramientas individuales en GitLab.com Enterprise/Premium (1030 auto-gestionado), consolidadas en 33 meta-herramientas base mediante el Model Context Protocol
  image:
