...
description: Servidor MCP con hasta 1011 herramientas GitLab, 32/47/48 meta-herramientas, recursos, prompts y transportes stdio/HTTP
hero:
...
| ------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------- |
| **32/47/48 Meta-herramientas**  | Herramientas agrupadas por dominio que cubren proyectos, issues, merge requests, pipelines, CI/CD, wikis, releases, Orbit y más                |
