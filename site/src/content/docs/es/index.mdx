...
description: Servidor MCP con hasta 1028 (1034 en GitLab.com Enterprise/Premium) herramientas GitLab, 32/48/49 meta-herramientas, recursos, prompts y transportes stdio/HTTP
hero:
...
| **32/48/49 Meta-herramientas** | Modo opcional por dominio que cubre proyectos, issues, merge requests, pipelines, CI/CD, wikis, releases, Orbit y más                            |
