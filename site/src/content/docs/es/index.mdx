...
<CardGrid>
  <LinkCard title="Primeros pasos" href="/es/getting-started/" description="Instala el binario y conéctalo a tu primer cliente de IA en minutos" />
  <LinkCard title="Arquitectura" href="/es/architecture/" description="Comprende cómo el servidor conecta los asistentes de IA con GitLab" />
  <LinkCard title="Configuración" href="/es/configuration/" description="Variables de entorno, configuraciones de clientes y opciones de despliegue" />
  <LinkCard title="Referencia de herramientas" href="/es/tools/" description="Explora todas las herramientas MCP disponibles por dominio" />
</CardGrid>
