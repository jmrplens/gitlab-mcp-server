...
description: Servidor MCP con hasta 1033 herramientas GitLab, 33/49/50 meta-herramientas, recursos, prompts y transportes stdio/HTTP
hero:
  tagline: Conecta tu asistente de IA a GitLab con hasta 1033 herramientas mediante el Model Context Protocol
  image:
