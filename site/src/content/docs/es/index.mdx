...
description: Servidor MCP con hasta 1022 herramientas GitLab, 33/49/50 meta-herramientas, recursos, prompts y transportes stdio/HTTP
hero:
  tagline: Conecta tu asistente de IA a GitLab con hasta 1022 herramientas mediante el Model Context Protocol
  image:
...
| **46 Recursos MCP**             | Endpoints de datos de solo lectura para información de proyectos, perfiles de usuario, configuración del servidor y esquemas de meta-tools     |
