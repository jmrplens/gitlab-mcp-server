...
| `GITLAB_ENTERPRISE`      | _(sin definir)_      | **Deprecado** — usa `GITLAB_TIER`. Solo se respeta cuando `GITLAB_TIER` no está definido: `true` → `ultimate`, `false` → `free`. Emite una advertencia de deprecación                                                                                                                                                                                   |
