...
:::tip
**El modo dinámico** (`TOOL_SURFACE=dynamic`) es el predeterminado y el catálogo visible de menor consumo. Expone `gitlab_find_action` y `gitlab_execute_tool`, mientras conserva el mismo catálogo canónico de acciones GitLab.
