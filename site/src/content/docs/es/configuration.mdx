...
| ------------------------ | -------------- | --------------------------------------------------------------------------------------------------------- |
| `GITLAB_USER`            | —              | Nombre de usuario de GitLab (informativo, usado en prompts)                                               |
| `GITLAB_SKIP_TLS_VERIFY` | `false`        | Omitir verificación de certificados TLS para certificados autofirmados                                    |
| `META_TOOLS`             | `true`         | Habilitar modo meta-herramientas (40 herramientas de dominio en lugar de 1000+ herramientas individuales) |
| `GITLAB_ENTERPRISE`      | `false`        | Habilitar 19 herramientas adicionales para funciones de GitLab Premium/Ultimate                           |
...
| `ISSUE_REPORTS` | `false`        | Generar informes detallados de issues en caso de fallos de herramientas |
