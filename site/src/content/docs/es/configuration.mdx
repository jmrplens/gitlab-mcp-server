...
| `TOOL_SURFACE`           | `meta`               | Selector canónico del catálogo: `meta`, `individual` o `dynamic`                                                                                                                                                                                            |
...
Usa `TOOL_SURFACE=dynamic` para el catálogo visible estable más pequeño: solo se exponen `gitlab_find_action` y `gitlab_execute_tool`, respaldadas por el mismo catálogo canónico de acciones de GitLab.
