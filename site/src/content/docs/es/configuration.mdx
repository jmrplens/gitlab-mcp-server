...
| `--exclude-tools`          | _(vacío)_         | Nombres de herramienta, de grupo o IDs canónicos de acción separados por comas; se excluyen de la superficie de herramientas y de los recursos, suscripciones, prompts y compleciones de argumentos que devuelven los mismos objetos. Las mismas formas alcanzan a las utilidades independientes en todas las superficies, y una entrada que no nombra nada se registra como aviso al arrancar                                           |
