...
| `GITLAB_MCP_ACTION_TIMEOUT`            | `65m`          | Cancela una acción que siga en marcha tras este tiempo; `0` lo desactiva (límite 24h). Por encima de la espera más larga que ofrece cualquier acción. También corta una subida o descarga de un fichero que siga en marcha al llegar al límite. Ambos transportes; el modo HTTP tiene además `--action-timeout`                                                                                                                                                                                                       |
