...
| `META_TOOLS`             | `true`         | Habilitar modo meta-herramientas (32 herramientas de dominio en lugar de 1000+ herramientas individuales) |
...
| `ENABLE_RESOURCES`      | `true`         | Habilitar 44 recursos MCP para acceso de datos de solo lectura       |
