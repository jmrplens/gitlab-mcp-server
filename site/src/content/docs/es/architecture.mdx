...
Con `META_TOOLS=true` (predeterminado), el servidor expone **28 meta-herramientas a nivel de dominio** (43 con enterprise) en lugar de más de 1000 herramientas individuales. Cada meta-herramienta agrupa operaciones relacionadas:
