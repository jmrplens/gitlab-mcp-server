...
El [índice completo de ADR](https://github.com/jmrplens/gitlab-mcp-server/blob/main/docs/development/adr/README.md) cubre el resto de decisiones, incluidas la estrategia de migración a GraphQL y la contrapartida de la suscripción a recursos.
