...
- **Meta-herramientas** (`TOOL_SURFACE=meta`) agrupan acciones relacionadas detrás de herramientas de dominio como `gitlab_issue`.
- **Herramientas individuales** (`TOOL_SURFACE=individual`) proyectan una herramienta MCP visible por acción para compatibilidad y pruebas.
