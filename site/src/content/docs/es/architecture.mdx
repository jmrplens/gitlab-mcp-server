...
Con `META_TOOLS=true` (predeterminado), el servidor expone **32 meta-herramientas por dominio** (47 en Enterprise/Premium autoalojado, 48 en GitLab.com Enterprise/Premium con Orbit) en lugar del catálogo individual. Cada meta-herramienta agrupa operaciones relacionadas:
