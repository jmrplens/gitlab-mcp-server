...
Con `META_TOOLS=true` (predeterminado), el servidor expone **42 meta-herramientas a nivel de dominio** en lugar de más de 1000 herramientas individuales. Cada meta-herramienta agrupa operaciones relacionadas:
