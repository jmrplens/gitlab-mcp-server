...
:::tip
Para mayor seguridad, usa variables de entrada de VS Code para evitar almacenar el token en texto plano. Consulta la página de [Configuración](/es/configuration/) para más detalles.
:::
