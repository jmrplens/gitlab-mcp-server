...
`PRIVATE-TOKEN` es obligatoria y viaja en cada petición — nunca se guarda en el servidor. `GITLAB-URL` es opcional y por defecto vale `https://gitlab.com`; ponla para llegar a otra instancia, que debe ser accesible desde Internet.
