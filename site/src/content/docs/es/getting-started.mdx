...
Publicado como [`gitlab-mcp-server`](https://pypi.org/project/gitlab-mcp-server/) con el mismo modelo que `uv` y `ruff`: cada wheel de plataforma lleva el binario nativo, el instalador lo coloca en la ruta de scripts como el propio comando, y no se ejecuta Python cuando corre el servidor.
