...
Por defecto, el servidor funciona en **modo meta-herramientas** — en lugar de registrar 1006 herramientas individuales (que consumirían la mayor parte de la ventana de contexto del LLM), las consolida en **28 meta-herramientas a nivel de dominio** (43 con enterprise) que cubren el 100% de la funcionalidad.
