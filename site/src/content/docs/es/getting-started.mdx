...
description: Instala y configura GitLab MCP Server en menos de cinco minutos — con Docker, binario nativo o npm — para VS Code, Claude, Cursor y otros clientes MCP.
chips:
...
- **Tres formas de instalarlo**: una imagen Docker, un único binario nativo o el lanzador de npm.
