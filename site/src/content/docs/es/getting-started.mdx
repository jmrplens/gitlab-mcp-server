...
Por defecto, el servidor funciona en **modo meta-herramientas** — en lugar de registrar 1000 herramientas individuales (que consumirían la mayor parte de la ventana de contexto del LLM), las consolida en **32 meta-herramientas por dominio** (47 con enterprise) que cubren el 100% de la funcionalidad.
