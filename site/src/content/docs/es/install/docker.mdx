...
`GITLAB_MCP_SKIP_TLS_VERIFY=true` es la alternativa a lo bruto: desactiva la verificación de certificados para todas las peticiones a GitLab, y el modo OAuth la rechaza para una instancia que no sea loopback.
:::
