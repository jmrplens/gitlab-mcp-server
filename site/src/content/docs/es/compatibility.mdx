...
| Capacidad   |                                  Soportada                                  |
| ----------- | :-------------------------------------------------------------------------: |
| Tools       | ✅ (hasta 1022 individuales / 33 base, 49 autoalojadas, 50 GitLab.com meta) |
| Resources   |                                   ✅ (46)                                   |
| Prompts     |                                   ✅ (37)                                   |
...
La cifra de 1022 herramientas individuales es el conjunto expandido de instancias de herramienta distintas. Los recuentos de 33 base, 49 autoalojadas y 50 en GitLab.com son tamaños del catálogo de meta-herramientas cuyas acciones se expanden a esa superficie individual mayor.
