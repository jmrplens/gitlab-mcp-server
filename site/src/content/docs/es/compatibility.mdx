...
GitLab MCP Server funciona tanto con Community Edition (CE) como con Enterprise Edition (EE). La variable de entorno `GITLAB_ENTERPRISE` desbloquea 19 meta-herramientas adicionales exclusivas de Enterprise.
...
| +19 meta-herramientas enterprise | ❌ | ✅ |
...
| Capacidad | Soportada |
|-----------|:---------:|
| Tools | ✅ (1004 individuales / 40–59 meta) |
| Resources | ✅ (24) |
| Prompts | ✅ (38) |
