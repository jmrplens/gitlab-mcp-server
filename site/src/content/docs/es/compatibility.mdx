...
| Capacidad   |                                  Soportada                                  |
| ----------- | :-------------------------------------------------------------------------: |
| Tools       | ✅ (hasta 1011 individuales / 33 base, 47 autoalojadas, 48 GitLab.com meta) |
| Resources   |                                   ✅ (46)                                   |
| Prompts     |                                   ✅ (38)                                   |
...
La cifra de 1011 herramientas individuales es el conjunto expandido de instancias de herramienta distintas. Los recuentos de 33 base, 47 autoalojadas y 48 en GitLab.com son tamaños del catálogo de meta-herramientas cuyas acciones se expanden a esa superficie individual mayor.
