...
| Capacidad   |                                                           Soportada                                                           |
| ----------- | :---------------------------------------------------------------------------------------------------------------------------: |
| Tools       | ✅ (hasta 1039 autoalojadas Enterprise / 1045 GitLab.com + Orbit individuales / 33 base, 49 autoalojadas, 50 GitLab.com meta) |
| Resources   |                                                            ✅ (46)                                                            |
| Prompts     |                                                            ✅ (37)                                                            |
...
Las cifras de 1039 autoalojadas y 1045 en GitLab.com son el conjunto expandido de instancias de herramienta distintas. Los recuentos de 33 base, 49 autoalojadas y 50 en GitLab.com son tamaños del catálogo de meta-herramientas cuyas acciones se expanden a esa superficie individual mayor.
