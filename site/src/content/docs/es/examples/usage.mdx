...
:::tip
Estos ejemplos muestran el modo meta-herramienta con `TOOL_SURFACE=meta`. Cada prompt se mapea a una única llamada de meta-herramienta con el parámetro `action` apropiado. El asistente de IA maneja el mapeo automáticamente — simplemente describe lo que necesitas en lenguaje natural.
:::
