...
faq:
  ...
  - q: "¿Cómo le indico al asistente qué proyecto de GitLab usar?"
    a: "Pasa la ruta del proyecto en `project_id`, con la forma `grupo/proyecto` — por ejemplo `mi-grupo/backend`. Los IDs numéricos también funcionan. Si trabajas dentro de un repositorio clonado, `gitlab_resolve_project` traduce la URL del remoto git al proyecto correcto de GitLab, así que no necesitas indicarlo."
