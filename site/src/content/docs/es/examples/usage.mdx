...
faq:
  ...
  - q: "¿Un asistente de IA puede modificar mis datos de GitLab sin preguntar?"
    a: "No sin desactivar antes alguna salvaguarda. Las acciones destructivas exigen confirmación explícita antes de ejecutarse, `GITLAB_MCP_READ_ONLY=true` elimina del catálogo todas las acciones de escritura, y `GITLAB_MCP_SAFE_MODE=true` intercepta las mutaciones y devuelve una previsualización JSON de lo que ocurriría en vez de aplicarlo. Las operaciones de lectura, como listar y buscar, son siempre seguras."
---
