...
description: "Ejemplos CI/CD paso a paso con GitLab MCP Server: diagnosticar pipelines fallidos, gestionar variables, programar builds, controlar entornos y leer métricas DORA."
---
