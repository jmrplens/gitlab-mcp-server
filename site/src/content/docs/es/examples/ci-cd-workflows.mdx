...
:::tip
Todos los ejemplos de CI/CD usan el modo meta-tool con `TOOL_SURFACE=meta`. El asistente de IA mapea tu petición en lenguaje natural al parámetro `action` correcto automáticamente.
:::
