...
La instancia de GitLab que configures es el único host con el que contacta el
servidor. No hay comprobación de actualizaciones, ni clave de licencia que
validar, ni telemetría, así que no existe ningún otro destino de red.
