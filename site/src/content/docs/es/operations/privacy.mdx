...
guardarlos, con una clave que protege el sistema operativo: el Llavero
(Keychain) en macOS, DPAPI bajo tu sesión de Windows y el llavero del escritorio
(como GNOME Keyring o KWallet) en Linux. En un escritorio Linux sin
