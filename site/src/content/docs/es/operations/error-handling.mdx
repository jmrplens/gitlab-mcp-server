...
Para la referencia técnica completa, consulta [`docs/error-handling.md`](https://github.com/jmrplens/gitlab-mcp-server/blob/main/docs/error-handling.md) en el repositorio.
:::
