...
El servidor se comunica a través del [protocolo MCP](https://modelcontextprotocol.io/specification/2025-06-18/basic/transports#stdio) sobre stdin/stdout usando JSON-RPC 2.0. Cada interacción requiere un handshake `initialize`, una notificación `initialized`, y luego una o más solicitudes `tools/call`.
