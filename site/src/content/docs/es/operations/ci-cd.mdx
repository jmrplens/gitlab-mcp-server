...
| `schedule_*_variable` | CRUD de variables de programación (create, edit, delete); mismo prefijo en la superficie dinámica                                                                             |
...
| `download_artifacts` | Descargar el archivo de artefactos de un job                                                       |
...
| `x509: certificate signed by unknown authority` | Configura `GITLAB_MCP_SKIP_TLS_VERIFY=true`                                         |
...
Para la referencia técnica completa, consulta [`docs/guides/ci-cd.md`](https://github.com/jmrplens/gitlab-mcp-server/blob/main/docs/guides/ci-cd.md) en el repositorio.
:::
