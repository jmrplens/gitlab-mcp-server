...
Ambos modos se autentican con un **Personal Access Token** (PAT) o **Project Access Token**. El servidor soporta las 1005 herramientas completas al usar un token con scope `api`.
