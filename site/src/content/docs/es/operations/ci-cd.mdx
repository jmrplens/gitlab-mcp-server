...
Ambos modos se autentican con un **Personal Access Token** (PAT) o **Project Access Token**. El servidor soporta el catálogo individual completo al usar un token con scope `api`: 1006 herramientas en Enterprise/Premium autoalojado, o 1011 en GitLab.com Enterprise/Premium cuando Orbit está disponible.
