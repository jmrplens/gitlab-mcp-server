...
| HTTP, veinte credenciales, todas llamando |      271 a 843 MiB | Medido por la serie de concurrencia, un proceso por superficie         |
| HTTP, cien credenciales, todas llamando   |      0,5 a 2,0 GiB | La misma serie, en su paso de cien credenciales                        |
