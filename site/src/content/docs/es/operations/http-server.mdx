...
| `--rate-limit-rps`              | `10`              | Límite de tasa por credencial, en req/s, sobre toda llamada que llega a GitLab: `tools/call`, `resources/read`, `resources/subscribe`, `subscriptions/listen`, `prompts/get` (`0` lo desactiva); activo por defecto porque un despliegue HTTP es compartido                                                                                 |
