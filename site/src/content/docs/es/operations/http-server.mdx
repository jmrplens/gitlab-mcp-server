...
:::tip
Fija la imagen a una versión específica (ej. `ghcr.io/jmrplens/gitlab-mcp-server:1.4.0`) en producción. La etiqueta `latest` sigue al último release y puede cambiar inesperadamente.
:::
