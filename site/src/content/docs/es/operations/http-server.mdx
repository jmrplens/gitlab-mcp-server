...
| `--http-addr`              | `:8080`                      | Dirección de escucha: `host:puerto`, o una ruta del sistema de ficheros para escuchar en un socket unix (elimina el tramo hacia el proxy en vez de cifrarlo) |
