...
Para ejecutar la misma suite contra GitLab EE con herramientas Enterprise/Premium activadas, define `ENTERPRISE_LICENSE` en `.env` o en la shell y usa:
...
| Los tests Enterprise siguen saltándose      | `GITLAB_ENTERPRISE=true`, la imagen EE y `ENTERPRISE_LICENSE` en `.env`            |
