...
description: Ejecuta la suite end-to-end contra una instancia efímera de GitLab CE
---
...
El modo E2E con Docker arranca un entorno desechable de GitLab CE, provisiona fixtures, registra un runner de CI y ejecuta la suite end-to-end de MCP contra esa instancia local. Úsalo cuando necesites validación de alta confianza sin depender de una instancia real configurada en `.env`.

## Qué incluye

| Componente           | Propósito                                                                                                                  |
| -------------------- | -------------------------------------------------------------------------------------------------------------------------- |
| GitLab CE            | Instancia efímera de GitLab para llamadas reales a REST y GraphQL                                                          |
...
| ------------------------------------------- | ---------------------------------------------------------------------------------- |
| GitLab nunca queda listo                    | Límites de memoria y CPU de Docker; GitLab CE necesita varios GB de RAM            |
