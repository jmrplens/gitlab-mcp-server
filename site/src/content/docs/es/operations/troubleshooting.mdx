...
| Síntoma | Causa | Solución |
|---|---|---|
| El cliente MCP muestra 1004 herramientas en lugar de 40 | Meta-herramientas desactivadas | Establece `META_TOOLS=true` (por defecto) para consolidar en meta-herramientas de dominio |
...
| Herramientas enterprise faltantes | Modo enterprise desactivado | Establece `GITLAB_ENTERPRISE=true` para habilitar 19 meta-herramientas enterprise adicionales |
