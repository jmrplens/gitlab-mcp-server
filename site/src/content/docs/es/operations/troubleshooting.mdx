...
| Síntoma                                                 | Causa                                   | Solución                                                                                           |
| ------------------------------------------------------- | --------------------------------------- | -------------------------------------------------------------------------------------------------- |
| El cliente MCP muestra 1005 herramientas en lugar de 28 | Meta-herramientas desactivadas          | Establece `META_TOOLS=true` (por defecto) para consolidar en meta-herramientas de dominio          |
