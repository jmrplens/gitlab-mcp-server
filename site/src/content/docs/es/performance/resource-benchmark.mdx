...
encabezado, y cada gráfica repite en su borde inferior la parte de eso sin la
que no puede leerse fuera de esta página: cuántas CPU lógicas midieron, en qué
sistema operativo y con qué núcleo, y cuándo.
...
<ChartPair name="series-memory" lang="es" alt="Líneas sobre una escala logarítmica de credenciales con el pico de memoria residente de cada superficie por paso y el número de credenciales en que se detuvo cada serie." />
...
#### http, superficie meta: 4 en vuelo por credencial, 10 s por paso
...
#### http, superficie individual: 2 en vuelo por credencial, 10 s por paso
