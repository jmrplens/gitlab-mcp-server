...
Como los formularios multi-ronda viajan dentro del resultado de la herramienta, la elicitación sigue funcionando sobre el [transporte HTTP sin estado](/es/operations/http-server/#modo-sin-estado-stateless) predeterminado para clientes con protocolo `2026-07-28`. Los clientes con protocolo heredado necesitan un canal iniciado por el servidor, así que sobre HTTP sin estado reciben las alternativas no interactivas (avisos de error de los asistentes y `confirm` para acciones destructivas).
