...
faq:
  ...
  - q: "What does each release publish?"
    a: "Every release publishes signed binaries for Linux, macOS and Windows on both amd64 and arm64, a macOS universal binary, a container image on GHCR and Docker Hub, a Claude Desktop extension (.mcpb), and checksums with a detached GPG signature. Binary signatures can be verified with Cosign before you run anything."
