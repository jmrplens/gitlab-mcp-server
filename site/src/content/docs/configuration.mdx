...
| `META_TOOLS`             | `true`               | Enable meta-tool mode (32 base tools, 47 self-managed enterprise, or 48 GitLab.com Enterprise with Orbit instead of the individual catalog)                                       |
