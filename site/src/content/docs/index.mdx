...
<CardGrid>
  <LinkCard title="Getting Started" href="/en/getting-started/" description="Install the binary and connect to your first AI client in minutes" />
  <LinkCard title="Architecture" href="/en/architecture/" description="Understand how the server connects AI assistants to GitLab" />
  <LinkCard title="Configuration" href="/en/configuration/" description="Environment variables, client configs, and deployment options" />
  <LinkCard title="Tools Reference" href="/en/tools/" description="Browse all available MCP tools by domain" />
</CardGrid>
