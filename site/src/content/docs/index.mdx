...
hero:
  tagline: Up to 1034 individual tools on GitLab.com Enterprise/Premium (1028 self-managed), consolidated into 32 base meta-tools via the Model Context Protocol
  image:
...
| **Meta-Tools**           | Optional domain mode with 32 base tools, 49 on self-managed Enterprise/Premium, and 49 on GitLab.com Enterprise/Premium with Orbit, covering projects, issues, MRs, pipelines, CI/CD, and more |
