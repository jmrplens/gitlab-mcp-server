...
hero:
  tagline: Up to 1036 individual tools on GitLab.com Enterprise/Premium (1030 self-managed), consolidated into 33 base meta-tools via the Model Context Protocol
  image:
