...
hero:
  tagline: Up to 1045 individual tools on GitLab.com Enterprise/Premium (1039 self-managed), consolidated into 33 base meta-tools via the Model Context Protocol
  image:
...
| **Meta-Tools**           | Optional domain mode with 33 base tools, 49 on self-managed Enterprise/Premium, and 50 on GitLab.com Enterprise/Premium with Orbit, covering projects, issues, MRs, pipelines, CI/CD, and more |
| **46 MCP Resources**     | Read-only data endpoints for project info, user profiles, workflow guides, and the surface-aware `gitlab://tools` manifest                                                                     |
