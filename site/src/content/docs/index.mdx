...
description: MCP server with up to 1011 GitLab tools, 32 base meta-tools, 47 self-managed Enterprise/Premium meta-tools, 48 GitLab.com Enterprise/Premium meta-tools, resources, prompts, and stdio/HTTP transports
hero:
  tagline: Connect your AI assistant to GitLab with up to 1011 tools via the Model Context Protocol
  image:
...
| Feature                  | Details                                                                                                                                                                                          |
| ------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| **Meta-Tools**           | 32 base tools, 47 on self-managed Enterprise/Premium, and 48 on GitLab.com Enterprise/Premium with Orbit, covering projects, issues, merge requests, pipelines, CI/CD, wikis, releases, and more |
| **Dynamic Toolset**      | Optional low-token compact mode: search the canonical action catalog, describe exact schemas, then execute canonical GitLab actions                                                              |
...
<CardGrid>
	...
	<LinkCard
		...
		description="Use the low-token search, describe, execute mode"
	/>
</CardGrid>
