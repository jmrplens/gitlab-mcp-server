...
| **Meta-Tools**           | Optional domain mode with 32 base tools, 48 on self-managed Enterprise/Premium, and 49 on GitLab.com Enterprise/Premium with Orbit, covering projects, issues, MRs, pipelines, CI/CD, and more |
| **45 MCP Resources**     | Read-only data endpoints for project info, user profiles, workflow guides, and the surface-aware `gitlab://tools` manifest                                                                     |
| **37 MCP Prompts**       | Pre-built prompt templates for reports, audits, Git workflow quality, cross-project analysis, and team workflows                                                                               |
