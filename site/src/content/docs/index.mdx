...
| Feature                  | Details                                                                                                                                                                                          |
| ------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| **Meta-Tools**           | 33 base tools, 49 on self-managed Enterprise/Premium, and 50 on GitLab.com Enterprise/Premium with Orbit, covering projects, issues, merge requests, pipelines, CI/CD, wikis, releases, and more |
| **Dynamic Toolset**      | Optional 2-tool low-token mode: find canonical actions with exact schemas, then execute canonical GitLab actions                                                                                 |
...
| **Enterprise Tools**     | Optional Premium/Ultimate catalog: 15 self-managed meta-tools, plus GitLab.com-only Orbit Knowledge Graph tools                                                                                  |
