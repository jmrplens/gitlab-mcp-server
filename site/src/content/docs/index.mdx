...
description: MCP server with up to 1011 GitLab tools, 32/47/48 meta-tools, resources, prompts, and stdio/HTTP transports
hero:
...
| Feature                  | Details                                                                                                            |
| ------------------------ | ------------------------------------------------------------------------------------------------------------------ |
| **32/47/48 Meta-Tools**  | Domain-grouped tools covering projects, issues, merge requests, pipelines, CI/CD, wikis, releases, Orbit, and more |
