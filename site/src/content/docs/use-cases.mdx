...
GitLab MCP Server supports eight common workflows — code review, CI/CD automation, issue management, release management, team management, code search, reporting, and security review — each driven entirely through natural language. The cards below group capabilities by workflow rather than by API domain.
