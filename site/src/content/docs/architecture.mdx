...
With `META_TOOLS=true` (default), the server exposes **32 domain-level meta-tools** (47 with enterprise) instead of 1000+ individual tools. Each meta-tool groups related operations:
