...
With `META_TOOLS=true` (default), the server exposes **28 domain-level meta-tools** (43 with enterprise) instead of 1000+ individual tools. Each meta-tool groups related operations:
