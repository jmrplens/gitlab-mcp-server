...
The [full ADR index](https://github.com/jmrplens/gitlab-mcp-server/blob/main/docs/development/adr/README.md) covers the remaining decisions, including GraphQL migration strategy and the resource-subscription trade-off.
