...
2. **Translates** them into GitLab REST API v4 requests with proper authentication
...
With `META_TOOLS=true` (default), the server exposes **40 domain-level meta-tools** instead of 1000+ individual tools. Each meta-tool groups related operations:
