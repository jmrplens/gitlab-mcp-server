...
With `TOOL_SURFACE=individual`, all individual tools are exposed (e.g., `gitlab_list_issues`, `gitlab_create_issue`): 1027 on self-managed Enterprise/Premium, or 1033 on GitLab.com Enterprise/Premium with Orbit. This may be useful for testing but is not recommended for production.
