...
- [`gitlab-org/api/client-go`](https://pkg.go.dev/gitlab.com/gitlab-org/api/client-go/v2) (v2.57.0) — GitLab's own Go API client, used for every REST call; domains it does not wrap are issued as raw GraphQL
