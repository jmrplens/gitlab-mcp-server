...
| ------------------------ | --------: | ----------: |
| Source (`.go`, non-test) |     1,066 |     226,206 |
| Unit tests (`_test.go`)  |       635 |     367,816 |
| End-to-end tests         |       223 |      60,693 |
| **Total**                | **1,924** | **654,715** |
...
| Category                        |  Count |
| ------------------------------- | -----: |
| Source functions                |  8,483 |
| . Exported (public)             |  2,799 |
| . Unexported (private)          |  5,684 |
| Unit test functions (`TestXxx`) | 13,106 |
| Subtests (`t.Run(...)`)         |  4,870 |
| End-to-end test functions       |    567 |
...
| Comment lines in source            |  34,318 (~15.2% of source) |
...
| Pattern                            | Count |
| ---------------------------------- | ----: |
| `if err != nil` checks             | 7,091 |
| `defer` statements                 | 1,190 |
| `struct` types defined             | 2,881 |
...
| Record              | File                                   |
| ------------------- | -------------------------------------- |
| Longest source file | `cmd/server/main.go`. 4,401 lines      |
| Longest test file   | `cmd/server/main_test.go`. 8,780 lines |

### Because why not

| Fact                                 | Value                                                                                                |
| ------------------------------------ | ---------------------------------------------------------------------------------------------------- |
| Source code printed at 55 lines/page | ~4,112 pages of A4                                                                                   |
