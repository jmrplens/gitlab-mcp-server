...
| ------------------------ | --------: | ----------: |
| Source (`.go`, non-test) |     1,237 |     261,213 |
| Unit tests (`_test.go`)  |       727 |     423,872 |
...
| Category                        |  Count |
| ------------------------------- | -----: |
| Source functions                |  9,635 |
| . Exported (public)             |  2,983 |
| . Unexported (private)          |  6,652 |
| Unit test functions (`TestXxx`) | 14,403 |
| Subtests (`t.Run(...)`)         |  5,745 |
...
| Comment lines in source            |  47,258 (~18.1% of source) |
...
| Pattern                            | Count |
| ---------------------------------- | ----: |
| `if err != nil` checks             | 7,892 |
| `defer` statements                 | 1,363 |
| `struct` types defined             | 3,146 |
...
| Fact                                 | Value                                                                                                |
| ------------------------------------ | ---------------------------------------------------------------------------------------------------- |
| Source code printed at 55 lines/page | ~4,749 pages of A4                                                                                   |
| Source lines mentioning `"gitlab"`   | 15,026 (impossible to avoid)                                                                         |
