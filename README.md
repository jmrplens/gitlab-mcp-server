...
| ------------------------ | --------: | ----------: |
| Source (`.go`, non-test) |     1,215 |     252,033 |
...
| Comment lines in source            |  44,069 (~17.5% of source) |
...
| Fact                                 | Value                                                                                                |
| ------------------------------------ | ---------------------------------------------------------------------------------------------------- |
| Source code printed at 55 lines/page | ~4,582 pages of A4                                                                                   |
| Source lines mentioning `"gitlab"`   | 14,631 (impossible to avoid)                                                                         |
