...
| ------------------------ | --------: | ----------: |
| Source (`.go`, non-test) |     1,293 |     287,636 |
| Unit tests (`_test.go`)  |       794 |     472,041 |
...
| Category                        |  Count |
| ------------------------------- | -----: |
| Source functions                | 10,566 |
| . Exported (public)             |  3,173 |
| . Unexported (private)          |  7,393 |
| Unit test functions (`TestXxx`) | 15,456 |
| Subtests (`t.Run(...)`)         |  4,690 |
...
| Comment lines in source            |  58,860 (~20.5% of source) |
...
| Pattern                            | Count |
| ---------------------------------- | ----: |
| `if err != nil` checks             | 8,624 |
| `defer` statements                 | 1,073 |
| `struct` types defined             | 3,354 |
...
| Longest test file   | `cmd/server/main_test.go`. 10,878 lines |

### Because why not

| Fact                                 | Value                                                                                                |
| ------------------------------------ | ---------------------------------------------------------------------------------------------------- |
| Source code printed at 55 lines/page | ~5,229 pages of A4                                                                                   |
