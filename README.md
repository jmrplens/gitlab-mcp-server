...
| ------------------------ | --------: | ----------: |
| Source (`.go`, non-test) |     1,289 |     286,422 |
| Unit tests (`_test.go`)  |       791 |     470,136 |
...
| Category                        |  Count |
| ------------------------------- | -----: |
| Source functions                | 10,542 |
| . Exported (public)             |  3,164 |
| . Unexported (private)          |  7,378 |
| Unit test functions (`TestXxx`) | 15,415 |
| Subtests (`t.Run(...)`)         |  4,669 |
...
| Comment lines in source            |  58,178 (~20.3% of source) |
...
| Fact                                 | Value                                                                                                |
| ------------------------------------ | ---------------------------------------------------------------------------------------------------- |
| Source code printed at 55 lines/page | ~5,207 pages of A4                                                                                   |
| Source lines mentioning `"gitlab"`   | 15,415 (impossible to avoid)                                                                         |
