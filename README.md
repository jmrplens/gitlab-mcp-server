...
| ------------------------ | --------: | ----------: |
| Source (`.go`, non-test) |     1,221 |     255,695 |
| Unit tests (`_test.go`)  |       715 |     417,280 |
...
| Unit test functions (`TestXxx`) | 14,255 |
...
| Comment lines in source            |  45,459 (~17.8% of source) |
...
| Source lines mentioning `"gitlab"`   | 14,770 (impossible to avoid)                                                                         |
