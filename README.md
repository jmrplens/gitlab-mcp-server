...
| ------------------------ | --------: | ----------: |
| Source (`.go`, non-test) |     1,289 |     286,968 |
| Unit tests (`_test.go`)  |       791 |     471,296 |
| End-to-end tests         |       386 |      71,855 |
| **Total**                | **2,466** | **830,119** |
...
| Category                        |  Count |
| ------------------------------- | -----: |
| Source functions                | 10,558 |
| . Exported (public)             |  3,165 |
| . Unexported (private)          |  7,393 |
| Unit test functions (`TestXxx`) | 15,431 |
| Subtests (`t.Run(...)`)         |  4,680 |
...
| Comment lines in source            |  58,476 (~20.4% of source) |
...
| Pattern                            | Count |
| ---------------------------------- | ----: |
| `if err != nil` checks             | 8,607 |
| `defer` statements                 | 1,073 |
| `struct` types defined             | 3,342 |
...
| Record              | File                                    |
| ------------------- | --------------------------------------- |
| Longest source file | `cmd/server/main.go`. 4,717 lines       |
| Longest test file   | `cmd/server/main_test.go`. 10,965 lines |

### Because why not

| Fact                                 | Value                                                                                                |
| ------------------------------------ | ---------------------------------------------------------------------------------------------------- |
| Source code printed at 55 lines/page | ~5,217 pages of A4                                                                                   |
| Source lines mentioning `"gitlab"`   | 15,428 (impossible to avoid)                                                                         |
