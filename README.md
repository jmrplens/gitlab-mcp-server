...
| ------------------------ | --------: | ----------: |
| Source (`.go`, non-test) |     1,236 |     261,155 |
| Unit tests (`_test.go`)  |       726 |     423,918 |
...
| Category                        |  Count |
| ------------------------------- | -----: |
| Source functions                |  9,630 |
| . Exported (public)             |  2,979 |
| . Unexported (private)          |  6,651 |
| Unit test functions (`TestXxx`) | 14,398 |
...
| Comment lines in source            |  47,216 (~18.1% of source) |
...
| Pattern                            | Count |
| ---------------------------------- | ----: |
| `if err != nil` checks             | 7,894 |
| `defer` statements                 | 1,363 |
| `struct` types defined             | 3,144 |
...
| Fact                                 | Value                                                                                                |
| ------------------------------------ | ---------------------------------------------------------------------------------------------------- |
| Source code printed at 55 lines/page | ~4,748 pages of A4                                                                                   |
| Source lines mentioning `"gitlab"`   | 15,028 (impossible to avoid)                                                                         |
