...
| ------------------------ | --------: | ----------: |
| Source (`.go`, non-test) |     1,281 |     279,867 |
| Unit tests (`_test.go`)  |       788 |     490,052 |
...
| Comment lines in source            |  61,276 (~21.9% of source) |
...
| Pattern                            | Count |
| ---------------------------------- | ----: |
| `if err != nil` checks             | 8,729 |
| `defer` statements                 | 1,082 |
| `struct` types defined             | 3,270 |
