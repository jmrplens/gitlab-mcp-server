...
| ------------------------ | --------: | ----------: |
| Source (`.go`, non-test) |     1,296 |     286,971 |
| Unit tests (`_test.go`)  |       877 |     562,013 |
...
| Comment lines in source            |  65,103 (~22.7% of source) |
...
| Source lines mentioning `"gitlab"`   | 13,930 (impossible to avoid)                                                                         |
