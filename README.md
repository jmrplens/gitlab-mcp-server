...
| Category                        |  Count |
| ------------------------------- | -----: |
| Source functions                |  8,692 |
| . Exported (public)             |  2,844 |
| . Unexported (private)          |  5,848 |
| Unit test functions (`TestXxx`) | 13,446 |
| Subtests (`t.Run(...)`)         |  5,115 |
...
| Fact                                 | Value                                                                                                |
| ------------------------------------ | ---------------------------------------------------------------------------------------------------- |
| Source code printed at 55 lines/page | ~4,232 pages of A4                                                                                   |
