...
| ------------------------ | --------: | ----------: |
| Source (`.go`, non-test) |     1,072 |     227,220 |
| Unit tests (`_test.go`)  |       639 |     369,139 |
...
| Category                        |  Count |
| ------------------------------- | -----: |
| Source functions                |  8,513 |
| . Exported (public)             |  2,804 |
| . Unexported (private)          |  5,709 |
| Unit test functions (`TestXxx`) | 13,135 |
| Subtests (`t.Run(...)`)         |  4,893 |
...
| Comment lines in source            |  34,775 (~15.3% of source) |
