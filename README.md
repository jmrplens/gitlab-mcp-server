...
| ------------------------ | --------: | ----------: |
| Source (`.go`, non-test) |     1,288 |     284,528 |
| Unit tests (`_test.go`)  |       869 |     515,067 |
...
| Category                        |  Count |
| ------------------------------- | -----: |
| Source functions                |  9,981 |
| . Exported (public)             |  3,165 |
| . Unexported (private)          |  6,816 |
| Unit test functions (`TestXxx`) | 16,184 |
| Subtests (`t.Run(...)`)         |  5,420 |
...
| Comment lines in source            |  63,796 (~22.4% of source) |
...
| Fact                                 | Value                                                                                                |
| ------------------------------------ | ---------------------------------------------------------------------------------------------------- |
| Source code printed at 55 lines/page | ~5,173 pages of A4                                                                                   |
| Source lines mentioning `"gitlab"`   | 14,496 (impossible to avoid)                                                                         |
