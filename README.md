...
| ------------------------ | --------: | ----------: |
| Source (`.go`, non-test) |       979 |     196,792 |
| Unit tests (`_test.go`)  |       534 |     304,020 |
...
| Category                        |  Count |
| ------------------------------- | -----: |
| Source functions                |  7,365 |
| — exported (public)             |  2,586 |
| — unexported (private)          |  4,779 |
| Unit test functions (`TestXxx`) | 11,491 |
| Subtests (`t.Run(...)`)         |  2,860 |
...
| Comment lines in source            |  21,666 (~11.0% of source) |
...
| Fact                                 | Value                                                                                                |
| ------------------------------------ | ---------------------------------------------------------------------------------------------------- |
| Source code printed at 55 lines/page | ~3,578 pages of A4                                                                                   |
| Source lines mentioning `"gitlab"`   | 12,447 (impossible to avoid)                                                                         |
