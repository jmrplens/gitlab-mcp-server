...
| ------------------------ | --------: | ----------: |
| Source (`.go`, non-test) |     1,289 |     286,629 |
| Unit tests (`_test.go`)  |       791 |     470,968 |
...
| Category                        |  Count |
| ------------------------------- | -----: |
| Source functions                | 10,547 |
| . Exported (public)             |  3,165 |
| . Unexported (private)          |  7,382 |
| Unit test functions (`TestXxx`) | 15,426 |
...
| Comment lines in source            |  58,311 (~20.3% of source) |
...
| Fact                                 | Value                                                                                                |
| ------------------------------------ | ---------------------------------------------------------------------------------------------------- |
| Source code printed at 55 lines/page | ~5,211 pages of A4                                                                                   |
