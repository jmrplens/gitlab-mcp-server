...
| ------------------------ | --------: | ----------: |
| Source (`.go`, non-test) |     1,296 |     287,290 |
| Unit tests (`_test.go`)  |       878 |     565,582 |
...
| Unit test functions (`TestXxx`) | 17,140 |
...
| Comment lines in source            |  65,392 (~22.8% of source) |
...
| Fact                                 | Value                                                                                                |
| ------------------------------------ | ---------------------------------------------------------------------------------------------------- |
| Source code printed at 55 lines/page | ~5,223 pages of A4                                                                                   |
