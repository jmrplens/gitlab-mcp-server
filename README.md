...
| ------------------------ | --------: | ----------: |
| Source (`.go`, non-test) |     1,221 |     255,724 |
| Unit tests (`_test.go`)  |       715 |     418,092 |
...
| . Unexported (private)          |  6,492 |
| Unit test functions (`TestXxx`) | 14,277 |
...
| Comment lines in source            |  45,739 (~17.9% of source) |
