...
| ------------------------ | --------: | ----------: |
| Source (`.go`, non-test) |       990 |     200,196 |
| Unit tests (`_test.go`)  |       546 |     310,074 |
...
| Comment lines in source            |  22,777 (~11.4% of source) |
