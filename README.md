...
| ------------------------ | --------: | ----------: |
| Source (`.go`, non-test) |     1,294 |     285,390 |
| Unit tests (`_test.go`)  |       875 |     551,900 |
...
| Category                        |  Count |
| ------------------------------- | -----: |
| Source functions                | 10,006 |
| . Exported (public)             |  3,174 |
| . Unexported (private)          |  6,832 |
| Unit test functions (`TestXxx`) | 16,870 |
...
| Comment lines in source            |  64,426 (~22.6% of source) |
...
| Source lines mentioning `"gitlab"`   | 14,521 (impossible to avoid)                                                                         |
