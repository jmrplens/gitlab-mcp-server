...
| Average test file length           |                 ~646 lines |
| Comment lines in source            |  66,669 (~23.0% of source) |
...
| Fact                                 | Value                                                                                                |
| ------------------------------------ | ---------------------------------------------------------------------------------------------------- |
| Source code printed at 55 lines/page | ~5,268 pages of A4                                                                                   |
| Source lines mentioning `"gitlab"`   | 14,010 (impossible to avoid)                                                                         |
