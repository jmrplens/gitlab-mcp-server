...
| ------------------------ | --------: | ----------: |
| Source (`.go`, non-test) |       996 |     204,121 |
...
| Category                        |  Count |
| ------------------------------- | -----: |
| Source functions                |  7,758 |
| — exported (public)             |  2,689 |
| — unexported (private)          |  5,069 |
...
| Comment lines in source            |  24,421 (~12.0% of source) |
...
| Fact                                 | Value                                                                                                |
| ------------------------------------ | ---------------------------------------------------------------------------------------------------- |
| Source code printed at 55 lines/page | ~3,711 pages of A4                                                                                   |
