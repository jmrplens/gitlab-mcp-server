...
| ------------------------ | --------: | ----------: |
| Source (`.go`, non-test) |     1,143 |     231,411 |
| Unit tests (`_test.go`)  |       649 |     378,585 |
...
| Unit test functions (`TestXxx`) | 13,375 |
| Subtests (`t.Run(...)`)         |  5,089 |
...
| Pattern                            | Count |
| ---------------------------------- | ----: |
| `if err != nil` checks             | 7,271 |
| `defer` statements                 | 1,246 |
| `struct` types defined             | 2,918 |
| `//nolint` suppressions            |   297 |
...
| Record              | File                                    |
| ------------------- | --------------------------------------- |
| Longest source file | `cmd/server/main.go`. 4,462 lines       |
| Longest test file   | `cmd/server/main_test.go`. 10,316 lines |
...
| Source lines mentioning `"gitlab"`   | 13,556 (impossible to avoid)                                                                         |
