...
| ------------------------ | --------: | ----------: |
| Source (`.go`, non-test) |     1,281 |     279,919 |
| Unit tests (`_test.go`)  |       788 |     498,213 |
...
| Unit test functions (`TestXxx`) | 15,776 |
...
| Comment lines in source            |  61,331 (~21.9% of source) |
...
| Source lines mentioning `"gitlab"`   | 14,699 (impossible to avoid)                                                                         |
