...
| ------------------------ | --------: | ----------: |
| Source (`.go`, non-test) |     1,233 |     259,881 |
| Unit tests (`_test.go`)  |       723 |     421,867 |
...
| . Unexported (private)          |  6,640 |
| Unit test functions (`TestXxx`) | 14,337 |
| Subtests (`t.Run(...)`)         |  5,737 |
...
| Comment lines in source            |  46,877 (~18.0% of source) |
...
| Pattern                            | Count |
| ---------------------------------- | ----: |
| `if err != nil` checks             | 7,770 |
| `defer` statements                 | 1,359 |
| `struct` types defined             | 3,128 |
| `//nolint` suppressions            |   336 |
...
| Fact                                 | Value                                                                                                |
| ------------------------------------ | ---------------------------------------------------------------------------------------------------- |
| Source code printed at 55 lines/page | ~4,725 pages of A4                                                                                   |
| Source lines mentioning `"gitlab"`   | 14,867 (impossible to avoid)                                                                         |
