...
| ------------------------ | --------: | ----------: |
| Source (`.go`, non-test) |       993 |     201,192 |
| Unit tests (`_test.go`)  |       550 |     311,067 |
...
| Comment lines in source            |  23,128 (~11.5% of source) |
...
| Source lines mentioning `"gitlab"`   | 12,592 (impossible to avoid)                                                                         |
