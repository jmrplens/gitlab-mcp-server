...
| ------------------------ | --------: | ----------: |
| Source (`.go`, non-test) |     1,003 |     207,107 |
| Unit tests (`_test.go`)  |       560 |     320,763 |
| End-to-end tests         |       189 |      51,332 |
| **Total**                | **1,752** | **579,202** |
...
| Category                        |  Count |
| ------------------------------- | -----: |
| Source functions                |  7,854 |
| — exported (public)             |  2,715 |
| — unexported (private)          |  5,139 |
| Unit test functions (`TestXxx`) | 12,094 |
| Subtests (`t.Run(...)`)         |  3,112 |
...
| Comment lines in source            |  25,819 (~12.5% of source) |
