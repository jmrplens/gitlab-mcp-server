...
| ------------------------ | --------: | ----------: |
| Source (`.go`, non-test) |       975 |     195,215 |
...
| Category                        |  Count |
| ------------------------------- | -----: |
| Source functions                |  7,484 |
| — exported (public)             |  2,629 |
| — unexported (private)          |  4,855 |
...
| Comment lines in source            |  21,596 (~11.1% of source) |
...
| Fact                                 | Value                                                                                                |
| ------------------------------------ | ---------------------------------------------------------------------------------------------------- |
| Source code printed at 55 lines/page | ~3,549 pages of A4                                                                                   |
