...
| ------------------------ | --------: | ----------: |
| Source (`.go`, non-test) |     1,247 |     267,258 |
| Unit tests (`_test.go`)  |       736 |     437,736 |
| End-to-end tests         |       246 |      66,681 |
| **Total**                | **2,229** | **771,675** |
...
| Category                        |  Count |
| ------------------------------- | -----: |
| Source functions                |  9,778 |
| . Exported (public)             |  3,071 |
| . Unexported (private)          |  6,707 |
| Unit test functions (`TestXxx`) | 14,739 |
| Subtests (`t.Run(...)`)         |  5,992 |
| End-to-end test functions       |    609 |
...
| Comment lines in source            |  50,103 (~18.7% of source) |
...
| Record              | File                                    |
| ------------------- | --------------------------------------- |
| Longest source file | `cmd/server/main.go`. 4,715 lines       |
...
| Fact                                 | Value                                                                                                |
| ------------------------------------ | ---------------------------------------------------------------------------------------------------- |
| Source code printed at 55 lines/page | ~4,859 pages of A4                                                                                   |
