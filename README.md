...
| ------------------------ | --------: | ----------: |
| Source (`.go`, non-test) |     1,294 |     285,281 |
| Unit tests (`_test.go`)  |       875 |     551,737 |
...
| Category                        |  Count |
| ------------------------------- | -----: |
| Source functions                | 10,003 |
| . Exported (public)             |  3,174 |
| . Unexported (private)          |  6,829 |
| Unit test functions (`TestXxx`) | 16,868 |
| Subtests (`t.Run(...)`)         |  5,880 |
...
| Average source file length         |                 ~220 lines |
| Average test file length           |                 ~631 lines |
| Comment lines in source            |  64,362 (~22.6% of source) |
...
| Fact                                 | Value                                                                                                |
| ------------------------------------ | ---------------------------------------------------------------------------------------------------- |
| Source code printed at 55 lines/page | ~5,186 pages of A4                                                                                   |
| Source lines mentioning `"gitlab"`   | 14,518 (impossible to avoid)                                                                         |
