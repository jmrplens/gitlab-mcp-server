...
| ------------------------ | --------: | ----------: |
| Source (`.go`, non-test) |     1,044 |     221,060 |
| Unit tests (`_test.go`)  |       615 |     362,260 |
...
| Category                        |  Count |
| ------------------------------- | -----: |
| Source functions                |  8,301 |
| . Exported (public)             |  2,789 |
| . Unexported (private)          |  5,512 |
| Unit test functions (`TestXxx`) | 12,948 |
| Subtests (`t.Run(...)`)         |  4,771 |
...
| Comment lines in source            |  33,007 (~14.9% of source) |
...
| Fact                                 | Value                                                                                                |
| ------------------------------------ | ---------------------------------------------------------------------------------------------------- |
| Source code printed at 55 lines/page | ~4,019 pages of A4                                                                                   |
