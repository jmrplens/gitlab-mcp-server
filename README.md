...
| . Exported (public)             |  3,068 |
| . Unexported (private)          |  6,655 |
| Unit test functions (`TestXxx`) | 14,680 |
...
| Source lines mentioning `"gitlab"`   | 15,444 (impossible to avoid)                                                                         |
