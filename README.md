...
| ------------------------ | --------: | ----------: |
| Source (`.go`, non-test) |     1,246 |     266,994 |
...
| Category                        |  Count |
| ------------------------------- | -----: |
| Source functions                |  9,775 |
| . Exported (public)             |  3,071 |
| . Unexported (private)          |  6,704 |
| Unit test functions (`TestXxx`) | 14,735 |
| Subtests (`t.Run(...)`)         |  5,985 |
...
| Comment lines in source            |  49,973 (~18.7% of source) |
