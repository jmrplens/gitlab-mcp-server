...
| ------------------------ | --------: | ----------: |
| Source (`.go`, non-test) |       999 |     206,207 |
| Unit tests (`_test.go`)  |       564 |     311,143 |
...
| Category                        |  Count |
| ------------------------------- | -----: |
| Source functions                |  7,769 |
| — exported (public)             |  2,684 |
| — unexported (private)          |  5,085 |
| Unit test functions (`TestXxx`) | 11,688 |
| Subtests (`t.Run(...)`)         |  3,041 |
...
| Average test file length           |                 ~551 lines |
| Comment lines in source            |  27,308 (~13.2% of source) |
...
| Fact                                 | Value                                                                                                |
| ------------------------------------ | ---------------------------------------------------------------------------------------------------- |
| Source code printed at 55 lines/page | ~3,749 pages of A4                                                                                   |
