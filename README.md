...
| ------------------------ | --------: | ----------: |
| Source (`.go`, non-test) |     1,289 |     286,777 |
| Unit tests (`_test.go`)  |       791 |     471,062 |
...
| Unit test functions (`TestXxx`) | 15,428 |
| Subtests (`t.Run(...)`)         |  4,674 |
...
| Comment lines in source            |  58,396 (~20.4% of source) |
