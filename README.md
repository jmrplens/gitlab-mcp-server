...
| ------------------------ | --------: | ----------: |
| Source (`.go`, non-test) |     1,290 |     286,905 |
| Unit tests (`_test.go`)  |       792 |     470,770 |
...
| Category                        |  Count |
| ------------------------------- | -----: |
| Source functions                | 10,551 |
| . Exported (public)             |  3,165 |
| . Unexported (private)          |  7,386 |
| Unit test functions (`TestXxx`) | 15,424 |
...
| Comment lines in source            |  58,510 (~20.4% of source) |
...
| Fact                                 | Value                                                                                                |
| ------------------------------------ | ---------------------------------------------------------------------------------------------------- |
| Source code printed at 55 lines/page | ~5,216 pages of A4                                                                                   |
| Source lines mentioning `"gitlab"`   | 15,423 (impossible to avoid)                                                                         |
