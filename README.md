...
| ------------------------ | --------: | ----------: |
| Source (`.go`, non-test) |     1,303 |     289,620 |
| Unit tests (`_test.go`)  |       800 |     474,102 |
...
| Category                        |  Count |
| ------------------------------- | -----: |
| Source functions                | 10,615 |
| . Exported (public)             |  3,187 |
| . Unexported (private)          |  7,428 |
| Unit test functions (`TestXxx`) | 15,502 |
| Subtests (`t.Run(...)`)         |  4,714 |
...
| Comment lines in source            |  59,387 (~20.5% of source) |
...
| Fact                                 | Value                                                                                                |
| ------------------------------------ | ---------------------------------------------------------------------------------------------------- |
| Source code printed at 55 lines/page | ~5,265 pages of A4                                                                                   |
| Source lines mentioning `"gitlab"`   | 15,460 (impossible to avoid)                                                                         |
