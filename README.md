...
| ------------------------ | --------: | ----------: |
| Source (`.go`, non-test) |     1,290 |     286,783 |
| Unit tests (`_test.go`)  |       792 |     470,699 |
...
| Comment lines in source            |  58,444 (~20.4% of source) |
...
| Source lines mentioning `"gitlab"`   | 15,420 (impossible to avoid)                                                                         |
