...
| ------------------------ | --------: | ----------: |
| Source (`.go`, non-test) |     1,219 |     255,619 |
| Unit tests (`_test.go`)  |       714 |     417,620 |
...
| Comment lines in source            |  45,596 (~17.8% of source) |
...
| Source lines mentioning `"gitlab"`   | 14,761 (impossible to avoid)                                                                         |
