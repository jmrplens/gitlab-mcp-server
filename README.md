...
| ------------------------ | --------: | ----------: |
| Source (`.go`, non-test) |       992 |     200,904 |
| Unit tests (`_test.go`)  |       548 |     310,550 |
...
| Comment lines in source            |  23,008 (~11.5% of source) |
...
| Pattern                            | Count |
| ---------------------------------- | ----: |
| `if err != nil` checks             | 6,690 |
| `defer` statements                 |   908 |
