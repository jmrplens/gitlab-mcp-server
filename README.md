...
| ------------------------ | --------: | ----------: |
| Source (`.go`, non-test) |     1,221 |     255,901 |
| Unit tests (`_test.go`)  |       715 |     418,758 |
...
| Category                        |  Count |
| ------------------------------- | -----: |
| Source functions                |  9,443 |
| . Exported (public)             |  2,944 |
| . Unexported (private)          |  6,499 |
| Unit test functions (`TestXxx`) | 14,291 |
| Subtests (`t.Run(...)`)         |  5,705 |
...
| Comment lines in source            |  45,844 (~17.9% of source) |
...
| Fact                                 | Value                                                                                                |
| ------------------------------------ | ---------------------------------------------------------------------------------------------------- |
| Source code printed at 55 lines/page | ~4,652 pages of A4                                                                                   |
| Source lines mentioning `"gitlab"`   | 14,780 (impossible to avoid)                                                                         |
