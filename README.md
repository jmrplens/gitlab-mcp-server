...
| ------------------------ | --------: | ----------: |
| Source (`.go`, non-test) |     1,296 |     287,035 |
| Unit tests (`_test.go`)  |       878 |     562,779 |
...
| Comment lines in source            |  65,176 (~22.7% of source) |
...
| Fact                                 | Value                                                                                                |
| ------------------------------------ | ---------------------------------------------------------------------------------------------------- |
| Source code printed at 55 lines/page | ~5,218 pages of A4                                                                                   |
