...
| Unit tests (`_test.go`)  |       726 |     427,084 |
...
| Category                        |  Count |
| ------------------------------- | -----: |
| Source functions                |  9,666 |
| . Exported (public)             |  3,045 |
| . Unexported (private)          |  6,621 |
| Unit test functions (`TestXxx`) | 14,484 |
| Subtests (`t.Run(...)`)         |  5,819 |
