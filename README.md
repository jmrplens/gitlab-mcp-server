...
| ------------------------ | --------: | ----------: |
| Source (`.go`, non-test) |     1,039 |     220,489 |
| Unit tests (`_test.go`)  |       611 |     360,725 |
...
| Category                        |  Count |
| ------------------------------- | -----: |
| Source functions                |  8,285 |
| . Exported (public)             |  2,786 |
| . Unexported (private)          |  5,499 |
| Unit test functions (`TestXxx`) | 12,913 |
| Subtests (`t.Run(...)`)         |  4,749 |
...
| Comment lines in source            |  32,638 (~14.8% of source) |
...
| Fact                                 | Value                                                                                                |
| ------------------------------------ | ---------------------------------------------------------------------------------------------------- |
| Source code printed at 55 lines/page | ~4,008 pages of A4                                                                                   |
| Source lines mentioning `"gitlab"`   | 13,205 (impossible to avoid)                                                                         |
