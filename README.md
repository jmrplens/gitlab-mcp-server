...
| ------------------------ | --------: | ----------: |
| Source (`.go`, non-test) |     1,034 |     219,261 |
| Unit tests (`_test.go`)  |       606 |     358,678 |
...
| Category                        |  Count |
| ------------------------------- | -----: |
| Source functions                |  8,251 |
| . Exported (public)             |  2,773 |
| . Unexported (private)          |  5,478 |
| Unit test functions (`TestXxx`) | 12,863 |
...
| Comment lines in source            |  32,148 (~14.7% of source) |
...
| Fact                                 | Value                                                                                                |
| ------------------------------------ | ---------------------------------------------------------------------------------------------------- |
| Source code printed at 55 lines/page | ~3,986 pages of A4                                                                                   |
| Source lines mentioning `"gitlab"`   | 13,168 (impossible to avoid)                                                                         |
