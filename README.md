...
| ------------------------ | --------: | ----------: |
| Source (`.go`, non-test) |     1,232 |     259,382 |
| Unit tests (`_test.go`)  |       722 |     421,343 |
...
| Category                        |  Count |
| ------------------------------- | -----: |
| Source functions                |  9,582 |
| . Exported (public)             |  2,956 |
| . Unexported (private)          |  6,626 |
| Unit test functions (`TestXxx`) | 14,330 |
| Subtests (`t.Run(...)`)         |  5,734 |
...
| Comment lines in source            |  46,682 (~18.0% of source) |
...
| Pattern                            | Count |
| ---------------------------------- | ----: |
| `if err != nil` checks             | 7,768 |
| `defer` statements                 | 1,358 |
| `struct` types defined             | 3,125 |
...
| Fact                                 | Value                                                                                                |
| ------------------------------------ | ---------------------------------------------------------------------------------------------------- |
| Source code printed at 55 lines/page | ~4,716 pages of A4                                                                                   |
| Source lines mentioning `"gitlab"`   | 14,861 (impossible to avoid)                                                                         |
