...
| ------------------------ | --------: | ----------: |
| Source (`.go`, non-test) |     1,281 |     279,864 |
| Unit tests (`_test.go`)  |       788 |     495,848 |
...
| Unit test functions (`TestXxx`) | 15,733 |
| Subtests (`t.Run(...)`)         |  5,125 |
...
| Observation                        |                      Value |
| ---------------------------------- | -------------------------: |
| Test lines vs source lines         | 1.77× more tests than code |
| Average source file length         |                 ~218 lines |
| Average test file length           |                 ~629 lines |
| Comment lines in source            |  61,288 (~21.9% of source) |
...
| Pattern                            | Count |
| ---------------------------------- | ----: |
| `if err != nil` checks             | 8,766 |
| `defer` statements                 | 1,083 |
...
| Fact                                 | Value                                                                                                |
| ------------------------------------ | ---------------------------------------------------------------------------------------------------- |
| Source code printed at 55 lines/page | ~5,088 pages of A4                                                                                   |
| Source lines mentioning `"gitlab"`   | 14,697 (impossible to avoid)                                                                         |
