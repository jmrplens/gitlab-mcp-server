...
| ------------------------ | --------: | ----------: |
| Source (`.go`, non-test) |     1,238 |     262,901 |
| Unit tests (`_test.go`)  |       726 |     427,012 |
...
| Unit test functions (`TestXxx`) | 14,483 |
| Subtests (`t.Run(...)`)         |  5,817 |
...
| Comment lines in source            |  48,489 (~18.4% of source) |
