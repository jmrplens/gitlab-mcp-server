...
| ------------------------ | --------: | ----------: |
| Source (`.go`, non-test) |     1,039 |     220,497 |
...
| Category                        |  Count |
| ------------------------------- | -----: |
| Source functions                |  8,286 |
| . Exported (public)             |  2,786 |
| . Unexported (private)          |  5,500 |
...
| Comment lines in source            |  32,642 (~14.8% of source) |
...
| Fact                                 | Value                                                                                                |
| ------------------------------------ | ---------------------------------------------------------------------------------------------------- |
| Source code printed at 55 lines/page | ~4,009 pages of A4                                                                                   |
