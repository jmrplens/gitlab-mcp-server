...
| `meta` / `full`                                       |            33 |               864 | `opaque`            |            144,388 |        18,100 |      162,488 |
| `meta` / `minimal`                                    |            33 |               864 | `opaque`            |            144,388 |           555 |      144,943 |
| `individual` / `full`                                 |           860 |               860 | n/a                 |            678,532 |        18,100 |      696,632 |
...
| ------------------------ | --------: | ----------: |
| Source (`.go`, non-test) |       939 |     189,650 |
...
| Comment lines in source            |  19,914 (~10.5% of source) |
...
| Source lines mentioning `"gitlab"`   | 12,324 (impossible to avoid)                                                                         |
