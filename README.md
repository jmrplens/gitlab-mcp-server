...
| ------------------------ | --------: | ----------: |
| Source (`.go`, non-test) |     1,281 |     279,610 |
| Unit tests (`_test.go`)  |       786 |     474,230 |
...
| Comment lines in source            |  61,076 (~21.8% of source) |
