...
| ------------------------ | --------: | ----------: |
| Source (`.go`, non-test) |       991 |     200,959 |
| Unit tests (`_test.go`)  |       548 |     310,669 |
...
| Comment lines in source            |  23,074 (~11.5% of source) |
...
| Fact                                 | Value                                                                                                |
| ------------------------------------ | ---------------------------------------------------------------------------------------------------- |
| Source code printed at 55 lines/page | ~3,653 pages of A4                                                                                   |
