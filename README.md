...
| ------------------------ | --------: | ----------: |
| Source (`.go`, non-test) |     1,001 |     206,643 |
| Unit tests (`_test.go`)  |       570 |     311,806 |
...
| Unit test functions (`TestXxx`) | 11,708 |
...
| Comment lines in source            |  27,559 (~13.3% of source) |
...
| Fact                                 | Value                                                                                                |
| ------------------------------------ | ---------------------------------------------------------------------------------------------------- |
| Source code printed at 55 lines/page | ~3,757 pages of A4                                                                                   |
