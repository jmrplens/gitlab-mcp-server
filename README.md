...
| ------------------------ | --------: | ----------: |
| Source (`.go`, non-test) |     1,290 |     287,167 |
| Unit tests (`_test.go`)  |       792 |     471,947 |
...
| Category                        |  Count |
| ------------------------------- | -----: |
| Source functions                | 10,565 |
| . Exported (public)             |  3,165 |
| . Unexported (private)          |  7,400 |
| Unit test functions (`TestXxx`) | 15,451 |
| Subtests (`t.Run(...)`)         |  4,683 |
...
| Comment lines in source            |  58,553 (~20.4% of source) |
