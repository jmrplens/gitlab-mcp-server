...
| ------------------------ | --------: | ----------: |
| Source (`.go`, non-test) |     1,071 |     226,991 |
| Unit tests (`_test.go`)  |       638 |     368,849 |
| End-to-end tests         |       225 |      60,973 |
| **Total**                | **1,934** | **656,813** |
...
| Category                        |  Count |
| ------------------------------- | -----: |
| Source functions                |  8,509 |
| . Exported (public)             |  2,804 |
| . Unexported (private)          |  5,705 |
| Unit test functions (`TestXxx`) | 13,129 |
| Subtests (`t.Run(...)`)         |  4,890 |
| End-to-end test functions       |    573 |
...
| Comment lines in source            |  34,550 (~15.2% of source) |
...
| Pattern                            | Count |
| ---------------------------------- | ----: |
| `if err != nil` checks             | 7,114 |
| `defer` statements                 | 1,202 |
...
| Record              | File                                   |
| ------------------- | -------------------------------------- |
| Longest source file | `cmd/server/main.go`. 4,434 lines      |
| Longest test file   | `cmd/server/main_test.go`. 8,790 lines |

### Because why not

| Fact                                 | Value                                                                                                |
| ------------------------------------ | ---------------------------------------------------------------------------------------------------- |
| Source code printed at 55 lines/page | ~4,127 pages of A4                                                                                   |
| Source lines mentioning `"gitlab"`   | 13,348 (impossible to avoid)                                                                         |
