...
| ------------------------ | --------: | ----------: |
| Source (`.go`, non-test) |     1,183 |     244,491 |
| Unit tests (`_test.go`)  |       685 |     403,905 |
...
| Comment lines in source            |  41,539 (~17.0% of source) |
...
| Fact                                 | Value                                                                                                |
| ------------------------------------ | ---------------------------------------------------------------------------------------------------- |
| Source code printed at 55 lines/page | ~4,445 pages of A4                                                                                   |
| Source lines mentioning `"gitlab"`   | 14,426 (impossible to avoid)                                                                         |
