...
| ------------------------ | --------: | ----------: |
| Source (`.go`, non-test) |     1,294 |     285,346 |
| Unit tests (`_test.go`)  |       875 |     551,870 |
...
| Category                        |  Count |
| ------------------------------- | -----: |
| Source functions                | 10,005 |
| . Exported (public)             |  3,174 |
| . Unexported (private)          |  6,831 |
...
| Comment lines in source            |  64,396 (~22.6% of source) |
