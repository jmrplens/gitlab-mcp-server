...
const (
	...
	svgDeploy      = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16"><path fill="currentColor" d="M8 2v8m0 0l-3-3m3 3l3-3"/><line x1="3" y1="13" x2="13" y2="13" stroke="currentColor" stroke-width="1.5"/></svg>`
	...
	svgVariable    = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16"><text x="3" y="12" font-size="12" font-family="monospace" fill="currentColor">{x}</text></svg>`
	...
	svgUpload      = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16"><path fill="currentColor" d="M8 10V2m0 0L5 5m3-3l3 3"/><line x1="3" y1="13" x2="13" y2="13" stroke="currentColor" stroke-width="1.5"/></svg>`
	...
	svgAlert       = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16"><path fill="currentColor" d="M8 1L1 14h14zM8 6v4m0 2v1"/></svg>`
