...
// TestExtractHints_SectionThatEndsEmpty_YieldsNoHints verifies that a guidance section
...
// next_steps.
func TestExtractHints_SectionThatEndsEmpty_YieldsNoHints(t *testing.T) {
	md := "## x\n---\n" + hintsHeading + "\n\n\n"
	if hints := ExtractHints(md); hints != nil {
