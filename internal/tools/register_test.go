...
func TestRegisterAll_ToolNames(t *testing.T) {
	...
	expectedNames := map[string]bool{
		...
		"gitlab_bulk_import_list":                                  true,
		"gitlab_bulk_import_get":                                   true,
		"gitlab_bulk_import_cancel":                                true,
		"gitlab_bulk_import_entity_list":                           true,
		"gitlab_bulk_import_entity_get":                            true,
		"gitlab_bulk_import_entity_failures":                       true,
