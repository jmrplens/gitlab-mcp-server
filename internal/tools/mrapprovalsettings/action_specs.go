...
var approvalSettingsMeta = map[string]approvalSettingsMetaEntry{
	"gitlab_get_group_mr_approval_settings": {
		...
		relatedActions: []string{actionGroupUpdate, actionMRApprovalState, actionGroupGetScope},
	...
	"gitlab_update_group_mr_approval_settings": {
		...
		relatedActions: []string{actionGroupGet, actionMRApprovalState, actionGroupGetScope},
	...
	"gitlab_get_project_mr_approval_settings": {
		...
		relatedActions: []string{actionProjectUpdate, actionMRApprovalState, actionProjectGetScope},
	...
	"gitlab_update_project_mr_approval_settings": {
		...
		relatedActions: []string{actionProjectGet, actionMRApprovalState, actionProjectGetScope},
