...
func List(ctx context.Context, client *gitlabclient.Client, input ListInput) (ScopesOutput, error) {
	if input.ControllerID <= 0 {
		return ScopesOutput{}, errors.New(errControllerIDRequired)
	}
...
func AddInstanceScope(ctx context.Context, client *gitlabclient.Client, input AddInstanceScopeInput) (InstanceScopeOutput, error) {
	if input.ControllerID <= 0 {
		return InstanceScopeOutput{}, errors.New(errControllerIDRequired)
	}
	if err := ctx.Err(); err != nil {
	...
	if err != nil {
		...
		return InstanceScopeOutput{}, toolutil.WrapErrWithStatusHint("add runner controller instance scope", err, http.StatusConflict,
			"the controller may already have instance scope assigned. Use runner.controller_scope_list to verify")
	}
...
func RemoveInstanceScope(ctx context.Context, client *gitlabclient.Client, input RemoveInstanceScopeInput) error {
	...
	if err != nil {
		...
		return toolutil.WrapErrWithStatusHint("remove instance scope", err, http.StatusNotFound,
			"the controller may not have instance scope assigned. Use runner.controller_scope_list to verify")
	}
	return nil
}
...
func AddRunnerScope(ctx context.Context, client *gitlabclient.Client, input AddRunnerScopeInput) (RunnerScopeOutput, error) {
	if input.ControllerID <= 0 {
		return RunnerScopeOutput{}, errors.New(errControllerIDRequired)
	}
	if input.RunnerID <= 0 {
		return RunnerScopeOutput{}, errors.New(errRunnerIDRequired)
	}
	if err := ctx.Err(); err != nil {
...
func RemoveRunnerScope(ctx context.Context, client *gitlabclient.Client, input RemoveRunnerScopeInput) error {
	...
	if err != nil {
		...
		return toolutil.WrapErrWithStatusHint("remove runner scope", err, http.StatusNotFound,
			"the runner may not be scoped to this controller. Use runner.controller_scope_list to verify")
	}
	return nil
}
