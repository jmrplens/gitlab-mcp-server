...
var userTokenActionMeta = map[string]userTokenActionMetaEntry{
	"gitlab_list_impersonation_tokens": {
		...
		related:     []string{"impersonationtokens.get_impersonation_token", "impersonationtokens.create_impersonation_token", "impersonationtokens.revoke_impersonation_token"},
	...
	"gitlab_get_impersonation_token": {
		...
		related:     []string{"impersonationtokens.list_impersonation_tokens", "impersonationtokens.revoke_impersonation_token"},
	...
	"gitlab_create_impersonation_token": {
		...
		related:     []string{"impersonationtokens.list_impersonation_tokens", "impersonationtokens.revoke_impersonation_token", "impersonationtokens.create_personal_access_token"},
	...
	"gitlab_revoke_impersonation_token": {
		...
		related:     []string{"impersonationtokens.list_impersonation_tokens", "impersonationtokens.get_impersonation_token"},
	...
	"gitlab_create_personal_access_token": {
		...
		related:     []string{"impersonationtokens.create_impersonation_token", "impersonationtokens.list_impersonation_tokens"},
