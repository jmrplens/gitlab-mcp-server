...
func List(ctx context.Context, client *gitlabclient.Client, input ListInput) (ListOutput, error) {
	...
	if err != nil {
		return ListOutput{}, toolutil.WrapErrWithStatusHint("gitlab_list_project_iterations", err, http.StatusNotFound, "verify project_id with project.get. Iterations require Premium license")
	}
	out := ListOutput{
