...
// TestRegisterTools_MutationErrors covers error branches in register.go closures:
// delete (500), add (500), edit (500), get (500), inherited (500).
...
// branch in the project member delete handler when the user declines.
