...
func memberOptions(individualTool string) toolutil.ActionSpecOptions {
	...
	case "gitlab_project_members_list":
		...
		opts.RelatedActions = []string{"member.get", "member.add", "project.get", "user.get"}
		opts.ParameterGuidance = map[string]toolutil.ParameterGuidance{"project_id": projectIDGuidance}
	...
	case "gitlab_project_member_get":
		...
		opts.RelatedActions = []string{"members.list", "member.get_inherited", "member.edit", "member.delete"}
	...
	case "gitlab_project_member_get_inherited":
		...
		opts.RelatedActions = []string{"member.get", "members.list", "project.get"}
		opts.ParameterGuidance = map[string]toolutil.ParameterGuidance{"project_id": projectIDGuidance, "user_id": userIDGuidance}
	...
	case "gitlab_project_member_add":
		...
		opts.RelatedActions = []string{"members.list", "member.get", "member.edit", "user.get"}
	...
	case "gitlab_project_member_edit":
		...
		opts.RelatedActions = []string{"members.list", "member.get", "member.add", "member.delete"}
		opts.ParameterGuidance = map[string]toolutil.ParameterGuidance{
			"project_id": projectIDGuidance,
			"user_id":    userIDGuidance,
			"access_level": {
				SemanticRole:     "access_level",
