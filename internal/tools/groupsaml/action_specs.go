...
const (
	...
	actionGroupSAMLLinkAdd   = "group.saml_link_add"
	actionGroupSAMLLinkList  = "group.saml_link_list"
	actionGroupSAMLUsersList = "group.saml_users_list"
)
...
func groupSAMLOptions(individualTool string) toolutil.ActionSpecOptions {
	options := toolutil.ActionSpecOptions{
		...
		RelatedActions: []string{actionGroupGet, actionGroupSAMLLinkList, actionGroupSAMLUsersList},
		Edition:        "premium",
		OpenWorld:      true,
	...
	case "gitlab_group_saml_users_list":
		...
		options.RelatedActions = []string{actionGroupSAMLLinkList, "group.members", actionGroupGet}
	...
	case "gitlab_group_saml_link_get":
		...
		options.RelatedActions = []string{actionGroupSAMLLinkList, actionGroupSAMLLinkAdd, "group.saml_link_delete"}
