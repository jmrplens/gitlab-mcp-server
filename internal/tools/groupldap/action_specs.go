...
const actionGroupLDAPLinkAdd = "group.ldap_link_add"
...
func groupLDAPOptions(individualTool string) toolutil.ActionSpecOptions {
	...
	case "gitlab_group_ldap_link_list":
		...
		options.RelatedActions = []string{"group.get", actionGroupLDAPLinkAdd, "group.ldap_sync"}
	...
	case "gitlab_group_ldap_sync":
		...
		options.RelatedActions = []string{"group.ldap_link_list", actionGroupLDAPLinkAdd, "group.get"}
	...
	case "gitlab_group_ldap_link_delete":
		...
		options.RelatedActions = []string{"group.ldap_link_list", actionGroupLDAPLinkAdd, "group.ldap_sync"}
