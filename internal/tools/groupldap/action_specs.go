...
const (
	...
	actionGroupLDAPLinkAdd  = "group.ldap_link_add"
	actionGroupLDAPLinkList = "group.ldap_link_list"
	actionGroupLDAPSync     = "group.ldap_sync"
)
...
func groupLDAPOptions(individualTool string) toolutil.ActionSpecOptions {
	options := toolutil.ActionSpecOptions{
		...
		RelatedActions: []string{actionGroupGet, actionGroupLDAPLinkList, actionGroupLDAPSync},
		Edition:        "premium",
		OpenWorld:      true,
	...
	case "gitlab_group_ldap_sync":
		...
		options.RelatedActions = []string{actionGroupLDAPLinkList, actionGroupLDAPLinkAdd, actionGroupGet}
	...
	case "gitlab_group_ldap_link_delete_for_provider":
		...
		options.RelatedActions = []string{actionGroupLDAPLinkList, "group.ldap_link_delete", actionGroupLDAPSync}
