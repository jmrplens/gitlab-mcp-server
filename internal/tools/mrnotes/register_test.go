// register_test.go contains integration tests for the MR note tool closures
...
func TestRegisterTools_ErrorPaths(t *testing.T) {
	...
	tools := []struct {
		...
		{"gitlab_mr_notes_list", map[string]any{"project_id": "1", "merge_request_iid": 1}},
		{"gitlab_mr_note_get", map[string]any{"project_id": "1", "merge_request_iid": 1, "note_id": 1}},
		{"gitlab_mr_note_create", map[string]any{"project_id": "1", "merge_request_iid": 1, "body": "x"}},
		{"gitlab_mr_note_update", map[string]any{"project_id": "1", "merge_request_iid": 1, "note_id": 1, "body": "x"}},
	}
