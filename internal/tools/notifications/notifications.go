...
func buildUpdateOpts(e eventFields) *gl.NotificationSettingsOptions {
	...
	opts.CloseIssue = e.CloseIssue
	opts.CloseMergeRequest = e.CloseMergeRequest
	opts.FailedPipeline = e.FailedPipeline
	opts.FixedPipeline = e.FixedPipeline
	opts.IssueDue = e.IssueDue
	opts.MergeMergeRequest = e.MergeMergeRequest
	opts.MergeWhenPipelineSucceeds = e.MergeWhenPipelineSucceeds
	opts.MovedProject = e.MovedProject
	opts.NewEpic = e.NewEpic
	opts.NewIssue = e.NewIssue
	opts.NewMergeRequest = e.NewMergeRequest
	opts.NewNote = e.NewNote
	opts.PushToMergeRequest = e.PushToMergeRequest
	opts.ReassignIssue = e.ReassignIssue
	opts.ReassignMergeRequest = e.ReassignMergeRequest
