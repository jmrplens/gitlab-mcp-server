...
func TestBuildUpdateOpts_AllBooleans(t *testing.T) {
	tr := true
	fa := false
	opts := buildUpdateOpts("custom", "email@test.com",
		&tr, &fa, &tr, &fa, &tr, &fa, &tr, &fa, &tr, &fa,
		&tr, &fa, &tr, &fa, &tr, &fa, &tr, &fa)
...
func TestBuildUpdateOpts_UnknownLevel(t *testing.T) {
	opts := buildUpdateOpts("unknown_level", "", nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil)
	if opts.Level != nil {
...
func TestBuildUpdateOpts_EmptyLevel(t *testing.T) {
	opts := buildUpdateOpts("", "", nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil)
	if opts.Level != nil {
...
func TestBuildUpdateOpts_ValidLevels(t *testing.T) {
	for _, lv := range []string{"disabled", "participating", "watch", "global", "mention", "custom"} {
		t.Run(lv, func(t *testing.T) {
			opts := buildUpdateOpts(lv, "", nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil)
			if opts.Level == nil {
