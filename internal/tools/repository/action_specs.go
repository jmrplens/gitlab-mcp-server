...
func repositoryCompareSpec(route toolutil.ActionRoute) toolutil.ActionSpec {
	...
	options.RelatedActions = []string{actionMergeBase, actionTree, actionBranchList, actionReleaseList}
...
func repositoryOptionsForAction(individualTool string) toolutil.ActionSpecOptions {
	...
	case "gitlab_repository_blob":
		...
		options.RelatedActions = []string{actionTree, actionRawBlob}
	...
	case "gitlab_repository_raw_blob":
		...
		options.RelatedActions = []string{actionBlob, actionTree}
	...
	case "gitlab_repository_contributors":
		...
		options.RelatedActions = []string{actionTree, actionCommitList}
	...
	case "gitlab_repository_merge_base":
		...
		options.RelatedActions = []string{actionCompare, actionBranchList}
	...
	case "gitlab_repository_changelog_generate":
		...
		options.RelatedActions = []string{actionChangelogAdd, actionReleaseCreate, actionTagList}
	...
	case "gitlab_repository_changelog_add":
		...
		options.RelatedActions = []string{actionChangelogGenerate, actionReleaseCreate, actionTagCreate}
