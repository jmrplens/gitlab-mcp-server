...
func repositoryOptionsForAction(actionName, individualTool string) toolutil.ActionSpecOptions {
	...
	case "gitlab_repository_tree":
		...
		options.RelatedActions = []string{"repository.blob", "repository.raw_blob", actionBranchList}
	...
	case "gitlab_repository_blob":
		...
		options.RelatedActions = []string{actionRepositoryTree, "repository.raw_blob"}
	...
	case "gitlab_repository_raw_blob":
		...
		options.RelatedActions = []string{"repository.blob", actionRepositoryTree}
	...
	case "gitlab_repository_merge_base":
		...
		options.RelatedActions = []string{"repository.compare", actionBranchList}
	...
	case "gitlab_repository_archive":
		...
		options.RelatedActions = []string{actionRepositoryTree, actionTagList}
	...
	case "gitlab_repository_changelog_generate":
		...
		options.RelatedActions = []string{"repository.changelog_add", "release.create", actionTagList}
