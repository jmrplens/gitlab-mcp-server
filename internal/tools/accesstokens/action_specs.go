...
func ActionSpecs(client *gitlabclient.Client) []toolutil.ActionSpec {
	return []toolutil.ActionSpec{
		...
		accessTokenUpdateSpec("token_project_rotate", toolutil.RouteAction(client, ProjectRotate), "gitlab_project_access_token_rotate"),
		accessTokenUpdateSpec("token_project_rotate_self", toolutil.RouteAction(client, ProjectRotateSelf), "gitlab_project_access_token_rotate_self"),
		...
		accessTokenUpdateSpec("token_group_rotate", toolutil.RouteAction(client, GroupRotate), "gitlab_group_access_token_rotate"),
		accessTokenUpdateSpec("token_group_rotate_self", toolutil.RouteAction(client, GroupRotateSelf), "gitlab_group_access_token_rotate_self"),
		...
		accessTokenUpdateSpec("token_personal_rotate", toolutil.RouteAction(client, PersonalRotate), "gitlab_personal_access_token_rotate"),
		accessTokenUpdateSpec("token_personal_rotate_self", toolutil.RouteAction(client, PersonalRotateSelf), "gitlab_personal_access_token_rotate_self"),
...
func accessTokenUpdateSpec(name string, route toolutil.ActionRoute, individualTool string) toolutil.ActionSpec {
	options := accessTokenOptions(individualTool)
	options.Idempotent = true
	return toolutil.NewActionSpec(name, route, options)
}
