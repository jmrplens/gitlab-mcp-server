...
// file and protection_rules.go as one block, line 1 to the end of each, so no
// narrower placement suppresses the finding. The two are parallel by design:
// GitLab's registry tag protection rules and protection rules are distinct REST
