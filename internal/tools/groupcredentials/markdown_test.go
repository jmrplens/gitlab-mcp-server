...
func TestFormatPATListMarkdown(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			input: PATListOutput{
				Tokens: []PATOutput{
					{ID: 1, Name: "tok1", UserID: 10, State: "active", Scopes: []string{"api"}, ExpiresAt: "2025-01-01"},
...
func TestFormatSSHKeyListMarkdown(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			input: SSHKeyListOutput{
				Keys: []SSHKeyOutput{
					{ID: 5, Title: "key-1", UserID: 10, CreatedAt: "2024-01-01T00:00:00Z", ExpiresAt: "2025-06-01T00:00:00Z"},
					{ID: 6, Title: "key-2", UserID: 20, CreatedAt: "2024-02-01T00:00:00Z"},
				},
				Pagination: toolutil.PaginationOutput{Page: 1, TotalPages: 1, TotalItems: 2},
			},
			contains: []string{
