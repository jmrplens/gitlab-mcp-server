...
func toPATOutput(t *gl.GroupPersonalAccessToken) PATOutput {
	...
	if t.CreatedAt != nil {
		o.CreatedAt = t.CreatedAt.Format("2006-01-02T15:04:05Z")
	}
	if t.LastUsedAt != nil {
		o.LastUsedAt = t.LastUsedAt.Format("2006-01-02T15:04:05Z")
	}
	if t.ExpiresAt != nil {
...
func toSSHKeyOutput(k *gl.GroupSSHKey) SSHKeyOutput {
	...
	if k.CreatedAt != nil {
		o.CreatedAt = k.CreatedAt.Format("2006-01-02T15:04:05Z")
	}
	if k.ExpiresAt != nil {
		o.ExpiresAt = k.ExpiresAt.Format("2006-01-02T15:04:05Z")
	}
	if k.LastUsedAt != nil {
		o.LastUsedAt = k.LastUsedAt.Format("2006-01-02T15:04:05Z")
	}
	return o
}
