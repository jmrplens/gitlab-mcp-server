...
func ActionSpecs(client *gitlabclient.Client, enterprise bool) []toolutil.ActionSpec {
	specs := []toolutil.ActionSpec{
		...
		projectPremiumSpec(projectReadSpec("approval_config_get", toolutil.RouteAction(client, GetApprovalConfig), "gitlab_project_approval_config_get", "approval")),
		projectPremiumSpec(projectMutationSpec("approval_config_change", toolutil.RouteAction(client, ChangeApprovalConfig), "gitlab_project_approval_config_change", "approval")),
		projectPremiumSpec(projectReadSpec("approval_rule_list", toolutil.RouteAction(client, ListApprovalRules), "gitlab_project_approval_rule_list", "approval")),
		projectPremiumSpec(projectReadSpec("approval_rule_get", toolutil.RouteAction(client, GetApprovalRule), "gitlab_project_approval_rule_get", "approval")),
		projectPremiumSpec(projectCreateSpec("approval_rule_create", toolutil.RouteAction(client, CreateApprovalRule), "gitlab_project_approval_rule_create", "approval")),
		projectPremiumSpec(projectMutationSpec("approval_rule_update", toolutil.RouteAction(client, UpdateApprovalRule), "gitlab_project_approval_rule_update", "approval")),
		projectPremiumSpec(projectDestructiveUpdateSpec("approval_rule_delete", toolutil.RouteAction(client, DeleteApprovalRuleOutput), "gitlab_project_approval_rule_delete", "approval")),
		projectPremiumSpec(projectReadSpec("pull_mirror_get", toolutil.RouteAction(client, GetPullMirror), "gitlab_project_pull_mirror_get", "mirror")),
		projectPremiumSpec(projectMutationSpec("pull_mirror_configure", toolutil.RouteAction(client, ConfigurePullMirror), "gitlab_project_pull_mirror_configure", "mirror")),
		projectPremiumSpec(projectMutationSpec("start_mirroring", toolutil.RouteAction(client, StartMirroringOutput), "gitlab_project_start_mirroring", "mirror")),
