...
func TestFormatListMarkdown(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			input: ListOutput{
				Epics: []Output{
					{IID: 1, Title: "A", State: "opened", Author: "x", Labels: []string{"a", "b"}, CreatedAt: "2024-01-01T00:00:00Z"},
					{IID: 2, Title: "B", State: "closed", Author: "y", CreatedAt: "2024-02-01T00:00:00Z"},
				},
...
func TestFormatLinksMarkdown(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			input: LinksOutput{
				ChildEpics: []Output{
					{IID: 10, Title: "A", State: "opened", Author: "x", CreatedAt: "2024-01-01T00:00:00Z"},
					{IID: 11, Title: "B", State: "closed", Author: "y", CreatedAt: "2024-02-01T00:00:00Z"},
				},
			},
			wantParts: []string{
				"Child Epics (2)",
