// register_test.go contains integration tests for the issue discussion tool
...
// TestRegisterTools_DeleteError verifies that the delete-note handler returns an
// error result when the GitLab API fails, covering the if-err branch in the
