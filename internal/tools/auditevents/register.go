...
func RegisterTools(server *mcp.Server, client *gitlabclient.Client) {
	mcp.AddTool(server, &mcp.Tool{
		...
		Description: "List instance-level audit events (admin only). Supports filtering by date range. Returns: paginated list of audit events with ID, author, entity, event details.",
	...
	mcp.AddTool(server, &mcp.Tool{
		...
		Description: "Get a single instance-level audit event by ID (admin only). Returns: audit event with ID, author, entity, event details, and created timestamp.",
		Annotations: toolutil.ReadAnnotations,
		Icons:       toolutil.IconEvent,
	...
	mcp.AddTool(server, &mcp.Tool{
		...
		Description: "List audit events for a GitLab group. Supports filtering by date range. Returns: paginated list of audit events with ID, author, entity, event details.",
		Annotations: toolutil.ReadAnnotations,
		Icons:       toolutil.IconEvent,
	...
	mcp.AddTool(server, &mcp.Tool{
		...
		Description: "Get a single group-level audit event by ID. Returns: audit event with ID, author, entity, event details, and created timestamp.",
		Annotations: toolutil.ReadAnnotations,
		Icons:       toolutil.IconEvent,
	...
	mcp.AddTool(server, &mcp.Tool{
		...
		Description: "List audit events for a GitLab project. Supports filtering by date range. Returns: paginated list of audit events with ID, author, entity, event details.",
		Annotations: toolutil.ReadAnnotations,
		Icons:       toolutil.IconEvent,
	...
	mcp.AddTool(server, &mcp.Tool{
		...
		Description: "Get a single project-level audit event by ID. Returns: audit event with ID, author, entity, event details, and created timestamp.",
		Annotations: toolutil.ReadAnnotations,
		Icons:       toolutil.IconEvent,
