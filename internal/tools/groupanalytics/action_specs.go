...
var groupAnalyticsActionMeta = map[string]groupAnalyticsActionMetaEntry{
	"gitlab_get_recently_created_issues_count": {
		...
		related:     []string{actionMRCount, actionMembersCount, actionGroupGet},
	...
	"gitlab_get_recently_created_mr_count": {
		...
		related:     []string{actionIssuesCount, actionMembersCount, actionGroupGet},
	...
	"gitlab_get_recently_added_members_count": {
		...
		related:     []string{actionIssuesCount, actionMRCount, actionGroupGet},
