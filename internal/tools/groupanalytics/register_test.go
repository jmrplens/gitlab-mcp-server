// register_test.go contains integration tests for the group analytics tool
...
// analytics tools without panicking.
...
// TestRegisterTools_CallThroughMCP verifies all registered group analytics tools
