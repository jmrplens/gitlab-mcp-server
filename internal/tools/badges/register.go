...
func RegisterTools(server *mcp.Server, client *gitlabclient.Client) {
	...
	badgeTool := func(name, description string) *mcp.Tool {
	...
	mcp.AddTool(server, badgeTool("gitlab_list_project_badges", "List all badges of a project, including inherited group badges.\n\nSee also: gitlab_add_project_badge, gitlab_list_group_badges\n\nReturns: JSON array of badges with pagination."), func(ctx context.Context, req *mcp.CallToolRequest, input ListProjectInput) (*mcp.CallToolResult, ListProjectOutput, error) {
		start := time.Now()
	...
	mcp.AddTool(server, badgeTool("gitlab_get_project_badge", "Get a specific project badge by ID.\n\nSee also: gitlab_list_project_badges, gitlab_edit_project_badge\n\nReturns: JSON with badge details."), func(ctx context.Context, req *mcp.CallToolRequest, input GetProjectInput) (*mcp.CallToolResult, GetProjectOutput, error) {
		start := time.Now()
	...
	mcp.AddTool(server, badgeTool("gitlab_add_project_badge", "Add a new badge to a project. Badge URLs support placeholders like %{project_path}, %{default_branch}, %{commit_sha}.\n\nSee also: gitlab_list_project_badges, gitlab_preview_project_badge\n\nReturns: JSON with the badge details."), func(ctx context.Context, req *mcp.CallToolRequest, input AddProjectInput) (*mcp.CallToolResult, AddProjectOutput, error) {
		start := time.Now()
	...
	mcp.AddTool(server, badgeTool("gitlab_edit_project_badge", "Edit an existing project badge.\n\nSee also: gitlab_get_project_badge, gitlab_list_project_badges\n\nReturns: JSON with the badge details."), func(ctx context.Context, req *mcp.CallToolRequest, input EditProjectInput) (*mcp.CallToolResult, EditProjectOutput, error) {
		start := time.Now()
	...
	mcp.AddTool(server, badgeTool("gitlab_preview_project_badge", "Preview how a project badge renders after placeholder interpolation, without creating it.\n\nSee also: gitlab_add_project_badge, gitlab_list_project_badges\n\nReturns: JSON with rendered badge URLs."), func(ctx context.Context, req *mcp.CallToolRequest, input PreviewProjectInput) (*mcp.CallToolResult, PreviewProjectOutput, error) {
		start := time.Now()
	...
	mcp.AddTool(server, badgeTool("gitlab_list_group_badges", "List all badges of a group.\n\nSee also: gitlab_add_group_badge, gitlab_list_project_badges\n\nReturns: JSON array of badges with pagination."), func(ctx context.Context, req *mcp.CallToolRequest, input ListGroupInput) (*mcp.CallToolResult, ListGroupOutput, error) {
		start := time.Now()
	...
	mcp.AddTool(server, badgeTool("gitlab_get_group_badge", "Get a specific group badge by ID.\n\nSee also: gitlab_list_group_badges, gitlab_edit_group_badge\n\nReturns: JSON with badge details."), func(ctx context.Context, req *mcp.CallToolRequest, input GetGroupInput) (*mcp.CallToolResult, GetGroupOutput, error) {
		start := time.Now()
	...
	mcp.AddTool(server, badgeTool("gitlab_add_group_badge", "Add a new badge to a group. Badge URLs support placeholders like %{project_path}, %{default_branch}, %{commit_sha}.\n\nSee also: gitlab_list_group_badges, gitlab_preview_group_badge\n\nReturns: JSON with the badge details."), func(ctx context.Context, req *mcp.CallToolRequest, input AddGroupInput) (*mcp.CallToolResult, AddGroupOutput, error) {
		start := time.Now()
	...
	mcp.AddTool(server, badgeTool("gitlab_edit_group_badge", "Edit an existing group badge.\n\nSee also: gitlab_get_group_badge, gitlab_list_group_badges\n\nReturns: JSON with the badge details."), func(ctx context.Context, req *mcp.CallToolRequest, input EditGroupInput) (*mcp.CallToolResult, EditGroupOutput, error) {
		start := time.Now()
	...
	mcp.AddTool(server, badgeTool("gitlab_preview_group_badge", "Preview how a group badge renders after placeholder interpolation, without creating it.\n\nSee also: gitlab_add_group_badge, gitlab_list_group_badges\n\nReturns: JSON with rendered badge URLs."), func(ctx context.Context, req *mcp.CallToolRequest, input PreviewGroupInput) (*mcp.CallToolResult, PreviewGroupOutput, error) {
		start := time.Now()
