...
func assertBadgeCreateScopeGuidance(t *testing.T, byTool map[string]toolutil.ActionSpec) {
	...
	if !strings.Contains(projectAdd.Usage, "project badge") || !strings.Contains(projectAdd.Usage, "project_id") || !strings.Contains(projectAdd.Usage, "group_id") || !strings.Contains(projectAdd.Usage, "Group badges are managed by group.badge_list, group.badge_add, group.badge_edit and group.badge_delete.") {
	...
	if !strings.Contains(groupAdd.Usage, "group badge") || !strings.Contains(groupAdd.Usage, "group_id") || !strings.Contains(groupAdd.Usage, "project_id") || !strings.Contains(groupAdd.Usage, "Project badges are managed by project.badge_list, project.badge_add, project.badge_edit and project.badge_delete.") {
