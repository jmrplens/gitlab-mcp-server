...
const (
	...
	descriptionDeleteSecurityAttribute        = "Delete a GitLab security attribute via GraphQL. Requires Premium or Ultimate. Returns: deletion confirmation. See also: gitlab_create_security_category, gitlab_project_get, gitlab_group_get. API docs: https://docs.gitlab.com/api/graphql/reference/#mutationsecurityattributedestroy"
	descriptionUpdateProjectSecurityAttribute = "Add or remove GitLab security attributes on a project via GraphQL. Requires Premium or Ultimate. Returns: project security attribute assignments. See also: gitlab_create_security_attribute, gitlab_project_get. API docs: https://docs.gitlab.com/api/graphql/reference/#mutationsecurityattributeprojectupdate"
	descriptionBulkUpdateSecurityAttributes   = "Add, remove, or replace GitLab security attributes on multiple groups and projects via GraphQL. Requires Premium or Ultimate. Returns: bulk update status, execution mode, and selected target/attribute IDs. See also: gitlab_create_security_attribute, gitlab_project_get, gitlab_group_get. API docs: https://docs.gitlab.com/api/graphql/reference/#mutationbulkupdatesecurityattributes"
)
...
func securityAttributeCreateSpec(name string, route toolutil.ActionRoute, individualTool, description string) toolutil.ActionSpec {
	...
	options.InputSchemaOverrides = []toolutil.InputSchemaOverride{
		toolutil.SchemaPropertyOverride("attributes", map[string]any{schemaType: schemaTypeArr, schemaMinItems: 1}),
		toolutil.SchemaPropertyOverride("attributes.name", map[string]any{schemaMinLen: 1}),
		toolutil.SchemaPropertyOverride("attributes.description", map[string]any{schemaMinLen: 1}),
...
func securityAttributeUpdateSpec(name string, route toolutil.ActionRoute, individualTool, description string) toolutil.ActionSpec {
	...
	options.InputSchemaOverrides = []toolutil.InputSchemaOverride{
		...
		toolutil.SchemaPropertyOverride("name", map[string]any{schemaType: schemaTypeStr, schemaMinLen: 1}),
		toolutil.SchemaPropertyOverride("description", map[string]any{schemaType: schemaTypeStr}),
		toolutil.SchemaPropertyOverride("color", map[string]any{schemaType: schemaTypeStr, "pattern": hexColorSchemaPattern}),
	}
