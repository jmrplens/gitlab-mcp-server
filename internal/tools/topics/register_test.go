// register_test.go contains integration tests for the project topic tool
...
func TestRegisterTools_DeleteError(t *testing.T) {
	...
	result, err := session.CallTool(ctx, &mcp.CallToolParams{
		...
		Arguments: map[string]any{"topic_id": float64(1)},
	})
	if err != nil {
...
// branch in the gitlab_delete_topic handler when the user declines.
