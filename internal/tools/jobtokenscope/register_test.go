// register_test.go contains integration tests for the CI job token scope
...
// TestRegisterTools_DeleteErrors covers the if-err branches for remove-project
// and remove-group from job token allowlist in register.go.
...
// user declines.
func TestRegisterTools_RemoveConfirmDeclined(t *testing.T) {
