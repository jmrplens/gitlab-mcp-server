...
var geoActionMeta = map[string]geoActionMetaEntry{
	"gitlab_create_geo_site": {
		...
		related:     []string{"geo.list", "geo.get", "geo.edit"},
	...
	"gitlab_list_geo_sites": {
		...
		related:     []string{"geo.get", "geo.list_status", "geo.create"},
	...
	"gitlab_get_geo_site": {
		...
		related:     []string{"geo.list", "geo.edit", "geo.get_status"},
	...
	"gitlab_edit_geo_site": {
		...
		related:     []string{"geo.get", "geo.list", "geo.repair"},
	...
	"gitlab_delete_geo_site": {
		...
		related:     []string{"geo.get", "geo.list"},
	...
	"gitlab_repair_geo_site": {
		...
		related:     []string{"geo.get", "geo.get_status", "geo.edit"},
	...
	"gitlab_list_status_all_geo_sites": {
		...
		related:     []string{"geo.get_status", "geo.list"},
	...
	"gitlab_get_status_geo_site": {
		...
		related:     []string{"geo.list_status", "geo.get"},
