...
func toOutput(mt *gl.MergeTrain) Output {
	...
	if mt.MergeRequest != nil {
		...
		if mt.MergeRequest.CreatedAt != nil {
			out.MergeRequest.CreatedAt = mt.MergeRequest.CreatedAt.Format("2006-01-02T15:04:05Z")
		}
		if mt.MergeRequest.UpdatedAt != nil {
			out.MergeRequest.UpdatedAt = mt.MergeRequest.UpdatedAt.Format("2006-01-02T15:04:05Z")
		}
	}
	if mt.User != nil {
	...
	if mt.CreatedAt != nil {
		out.CreatedAt = mt.CreatedAt.Format("2006-01-02T15:04:05Z")
	}
	if mt.UpdatedAt != nil {
		out.UpdatedAt = mt.UpdatedAt.Format("2006-01-02T15:04:05Z")
	}
	if mt.MergedAt != nil {
		out.MergedAt = mt.MergedAt.Format("2006-01-02T15:04:05Z")
	}
	return out
}
