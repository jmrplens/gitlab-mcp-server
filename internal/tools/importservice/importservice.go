...
const (
	fmtFieldValueTableHeader = "| Field | Value |\n|---|---|\n"
	fmtIDRow                 = "| ID | %d |\n"
	fmtNameRow               = "| Name | %s |\n"
...
func FormatGitHubImport(out *GitHubImportOutput) string {
	...
	sb.WriteString(fmtFieldValueTableHeader)
	...
	toolutil.WriteHints(&sb, "Monitor import progress by checking the import status periodically")
	return sb.String()
}
