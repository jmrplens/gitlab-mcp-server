...
// TestRegisterTools_NoPanic verifies that RegisterTools registers all user email
...
// TestRegisterTools_CallThroughMCP verifies all registered user email tools
