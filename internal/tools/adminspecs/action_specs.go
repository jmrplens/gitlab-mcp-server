...
// Owner packages. This package declares the instance-administration specs and
// issues no request of its own: every admin handler lives in the domain
// package its route names, and that is the package the request recording
// writes down. The owner is therefore stated per action, beside the route it
// has to agree with, and never as one name for the whole file.
//
// It matters because the owner is a join key rather than a label. The request
// inventory names a package and nothing else, so an action owned by a package
// that issues nothing can be joined to no recording at all, and an action
// owned by the wrong package is attributed to somebody else's requests.
// TestActionSpecs_OwnerPackage_IsThePackageTheHandlerComesFrom holds each of
// these against the package its route's input type comes from, so a
// copy-pasted constant fails rather than lands.
const (
	ownerAlertManagement   = "alertmanagement"
	ownerAppStatistics     = "appstatistics"
	ownerAppearance        = "appearance"
	ownerApplications      = "applications"
	ownerBroadcastMessages = "broadcastmessages"
	ownerBulkImports       = "bulkimports"
	ownerClusterAgents     = "clusteragents"
	ownerCustomAttributes  = "customattributes"
	ownerDBMigrations      = "dbmigrations"
	ownerDependencyProxy   = "dependencyproxy"
	ownerErrorTracking     = "errortracking"
	ownerFeatures          = "features"
	ownerImportService     = "importservice"
	ownerLicense           = "license"
	ownerMetadata          = "metadata"
	ownerPlanLimits        = "planlimits"
	ownerSecureFiles       = "securefiles"
	ownerSettings          = "settings"
	ownerSidekiq           = "sidekiq"
	ownerSystemHooks       = "systemhooks"
	ownerTerraformStates   = "terraformstates"
	ownerTopics            = "topics"
...
func ActionSpecs(client *gitlabclient.Client) []toolutil.ActionSpec {
	return []toolutil.ActionSpec{
		adminReadSpec("topic_list", ownerTopics, toolutil.RouteAction(client, topics.List), "gitlab_list_topics"),
		adminReadSpec("topic_get", ownerTopics, toolutil.RouteAction(client, topics.Get), "gitlab_get_topic"),
		adminCreateSpec("topic_create", ownerTopics, toolutil.RouteAction(client, topics.Create), "gitlab_create_topic"),
		adminUpdateSpec("topic_update", ownerTopics, toolutil.RouteAction(client, topics.Update), "gitlab_update_topic"),
		adminDeleteSpec("topic_delete", ownerTopics, toolutil.DestructiveVoidAction(client, topics.Delete), "gitlab_delete_topic"),
		...
		adminReadSpec("broadcast_message_list", ownerBroadcastMessages, toolutil.RouteAction(client, broadcastmessages.List), "gitlab_list_broadcast_messages"),
		adminReadSpec("broadcast_message_get", ownerBroadcastMessages, toolutil.RouteAction(client, broadcastmessages.Get), "gitlab_get_broadcast_message"),
		...
		adminDeleteSpec("broadcast_message_delete", ownerBroadcastMessages, toolutil.DestructiveAction(client, broadcastmessages.DeleteOutput), "gitlab_delete_broadcast_message"),
		adminReadSpec("feature_list", ownerFeatures, toolutil.RouteAction(client, features.List), "gitlab_list_features"),
		adminReadSpec("feature_list_definitions", ownerFeatures, toolutil.RouteAction(client, features.ListDefinitions), "gitlab_list_feature_definitions"),
		adminUpdateCreateIndividualSpec("feature_set", ownerFeatures, features.SetRoute(client), "gitlab_set_feature_flag"),
		adminDeleteSpec("feature_delete", ownerFeatures, toolutil.DestructiveVoidAction(client, features.Delete), "gitlab_delete_feature_flag"),
		adminReadSpec("license_get", ownerLicense, toolutil.RouteAction(client, license.Get), "gitlab_get_license"),
		adminCreateSpec("license_add", ownerLicense, toolutil.RouteAction(client, license.Add), "gitlab_add_license"),
		adminDeleteSpec("license_delete", ownerLicense, toolutil.DestructiveVoidAction(client, license.Delete), "gitlab_delete_license"),
		adminReadSpec("system_hook_list", ownerSystemHooks, toolutil.RouteAction(client, systemhooks.List), "gitlab_list_system_hooks"),
		adminReadSpec("system_hook_get", ownerSystemHooks, toolutil.RouteAction(client, systemhooks.Get), "gitlab_get_system_hook"),
		adminCreateSpec("system_hook_add", ownerSystemHooks, toolutil.RouteAction(client, systemhooks.Add), "gitlab_add_system_hook"),
		...
		adminCreateSpec("system_hook_test", ownerSystemHooks, toolutil.RouteAction(client, systemhooks.Test), "gitlab_test_system_hook"),
		adminSystemHookSetURLVariableSpec(client),
		adminSystemHookDeleteURLVariableSpec(client),
		adminDeleteSpec("system_hook_delete", ownerSystemHooks, toolutil.DestructiveVoidAction(client, systemhooks.Delete), "gitlab_delete_system_hook"),
		adminReadSpec("sidekiq_queue_metrics", ownerSidekiq, toolutil.RouteAction(client, sidekiq.GetQueueMetrics), "gitlab_get_sidekiq_queue_metrics"),
		adminReadSpec("sidekiq_process_metrics", ownerSidekiq, toolutil.RouteAction(client, sidekiq.GetProcessMetrics), "gitlab_get_sidekiq_process_metrics"),
		adminReadSpec("sidekiq_job_stats", ownerSidekiq, toolutil.RouteAction(client, sidekiq.GetJobStats), "gitlab_get_sidekiq_job_stats"),
		...
		adminReadSpec("plan_limits_get", ownerPlanLimits, toolutil.RouteAction(client, planlimits.Get), "gitlab_get_plan_limits"),
		adminUpdateSpec("plan_limits_change", ownerPlanLimits, toolutil.RouteAction(client, planlimits.Change), "gitlab_change_plan_limits"),
		adminReadSpec("usage_data_service_ping", ownerUsageData, toolutil.RouteAction(client, usagedata.GetServicePing), "gitlab_get_service_ping"),
		adminReadSpec("usage_data_non_sql_metrics", ownerUsageData, toolutil.RouteAction(client, usagedata.GetNonSQLMetrics), "gitlab_get_non_sql_metrics"),
		adminReadSpec("usage_data_queries", ownerUsageData, toolutil.RouteAction(client, usagedata.GetQueries), "gitlab_get_usage_queries"),
		adminReadSpec("usage_data_metric_definitions", ownerUsageData, toolutil.RouteAction(client, usagedata.GetMetricDefinitions), "gitlab_get_metric_definitions"),
		adminCreateSpec("usage_data_track_event", ownerUsageData, toolutil.RouteAction(client, usagedata.TrackEvent), "gitlab_track_event"),
		adminCreateSpec("usage_data_track_events", ownerUsageData, toolutil.RouteAction(client, usagedata.TrackEvents), "gitlab_track_events"),
		adminDestructiveUpdateIndividualSpec("db_migration_mark", ownerDBMigrations, toolutil.DestructiveAction(client, dbmigrations.Mark), "gitlab_mark_migration"),
		adminReadSpec("application_list", ownerApplications, toolutil.RouteAction(client, applications.List), "gitlab_list_applications"),
		adminCreateSpec("application_create", ownerApplications, toolutil.RouteAction(client, applications.Create), "gitlab_create_application"),
		...
		adminDeleteSpec("application_delete", ownerApplications, toolutil.DestructiveVoidAction(client, applications.Delete), "gitlab_delete_application"),
		adminApplicationStatisticsGetSpec(client),
		adminMetadataGetSpec(client),
		adminReadSpec("custom_attr_list", ownerCustomAttributes, toolutil.RouteAction(client, customattributes.List), "gitlab_list_custom_attributes"),
		adminReadSpec("custom_attr_get", ownerCustomAttributes, toolutil.RouteAction(client, customattributes.Get), "gitlab_get_custom_attribute"),
		adminUpdateCreateIndividualSpec("custom_attr_set", ownerCustomAttributes, toolutil.RouteAction(client, customattributes.Set), "gitlab_set_custom_attribute"),
		adminDeleteSpec("custom_attr_delete", ownerCustomAttributes, toolutil.DestructiveAction(client, customattributes.DeleteOutput), "gitlab_delete_custom_attribute"),
		adminCreateSpec("bulk_import_start", ownerBulkImports, toolutil.RouteAction(client, bulkimports.StartMigration), "gitlab_start_bulk_import"),
		adminReadSpec("bulk_import_list", ownerBulkImports, toolutil.RouteAction(client, bulkimports.List), "gitlab_list_bulk_imports"),
		adminReadSpec("bulk_import_get", ownerBulkImports, toolutil.RouteAction(client, bulkimports.Get), "gitlab_get_bulk_import"),
		adminUpdateSpec("bulk_import_cancel", ownerBulkImports, toolutil.RouteAction(client, bulkimports.Cancel), "gitlab_cancel_bulk_import"),
		adminReadSpec("bulk_import_entity_list", ownerBulkImports, toolutil.RouteAction(client, bulkimports.ListEntities), "gitlab_list_bulk_import_entities"),
		adminReadSpec("bulk_import_entity_get", ownerBulkImports, toolutil.RouteAction(client, bulkimports.GetEntity), "gitlab_get_bulk_import_entity"),
		adminReadSpec("bulk_import_entity_failures", ownerBulkImports, toolutil.RouteAction(client, bulkimports.ListEntityFailures), "gitlab_list_bulk_import_entity_failures"),
		adminReadSpec("error_tracking_list", ownerErrorTracking, toolutil.RouteAction(client, errortracking.ListClientKeys), "gitlab_list_error_tracking_client_keys"),
		adminCreateSpec("error_tracking_create", ownerErrorTracking, toolutil.RouteAction(client, errortracking.CreateClientKey), "gitlab_create_error_tracking_client_key"),
		adminDeleteSpec("error_tracking_delete", ownerErrorTracking, toolutil.DestructiveVoidAction(client, errortracking.DeleteClientKey), "gitlab_delete_error_tracking_client_key"),
		adminReadSpec("error_tracking_get_settings", ownerErrorTracking, toolutil.RouteAction(client, errortracking.GetSettings), "gitlab_get_error_tracking_settings"),
		adminUpdateSpec("error_tracking_update_settings", ownerErrorTracking, toolutil.RouteAction(client, errortracking.EnableDisable), "gitlab_enable_disable_error_tracking"),
		adminReadSpec("alert_metric_image_list", ownerAlertManagement, toolutil.RouteAction(client, alertmanagement.ListMetricImages), "gitlab_list_alert_metric_images"),
		adminCreateSpec("alert_metric_image_upload", ownerAlertManagement, toolutil.RouteAction(client, alertmanagement.UploadMetricImage), "gitlab_upload_alert_metric_image"),
		adminUpdateSpec("alert_metric_image_update", ownerAlertManagement, toolutil.RouteAction(client, alertmanagement.UpdateMetricImage), "gitlab_update_alert_metric_image"),
		adminDeleteSpec("alert_metric_image_delete", ownerAlertManagement, toolutil.DestructiveVoidAction(client, alertmanagement.DeleteMetricImage), "gitlab_delete_alert_metric_image"),
		adminReadSpec("secure_file_list", ownerSecureFiles, toolutil.RouteAction(client, securefiles.List), "gitlab_list_secure_files"),
		adminReadSpec("secure_file_get", ownerSecureFiles, toolutil.RouteAction(client, securefiles.Show), "gitlab_show_secure_file"),
		adminCreateSpec("secure_file_create", ownerSecureFiles, toolutil.RouteAction(client, securefiles.Create), "gitlab_create_secure_file"),
		adminDeleteSpec("secure_file_delete", ownerSecureFiles, toolutil.DestructiveVoidAction(client, securefiles.Remove), "gitlab_remove_secure_file"),
		adminReadSpec("terraform_state_list", ownerTerraformStates, toolutil.RouteAction(client, terraformstates.List), "gitlab_list_terraform_states"),
		adminReadSpec("terraform_state_get", ownerTerraformStates, toolutil.RouteAction(client, terraformstates.Get), "gitlab_get_terraform_state"),
		adminDeleteSpec("terraform_state_delete", ownerTerraformStates, toolutil.DestructiveVoidAction(client, terraformstates.Delete), "gitlab_delete_terraform_state"),
		adminUpdateSpec("terraform_state_lock", ownerTerraformStates, toolutil.RouteAction(client, terraformstates.Lock), "gitlab_lock_terraform_state"),
		adminTerraformStateUnlockSpec(client),
		adminDeleteSpec("terraform_version_delete", ownerTerraformStates, toolutil.DestructiveVoidAction(client, terraformstates.DeleteVersion), "gitlab_delete_terraform_state_version"),
		adminReadSpec("cluster_agent_list", ownerClusterAgents, toolutil.RouteAction(client, clusteragents.ListAgents), "gitlab_list_cluster_agents"),
		adminReadSpec("cluster_agent_get", ownerClusterAgents, toolutil.RouteAction(client, clusteragents.GetAgent), "gitlab_get_cluster_agent"),
		adminCreateSpec("cluster_agent_register", ownerClusterAgents, toolutil.RouteAction(client, clusteragents.RegisterAgent), "gitlab_register_cluster_agent"),
		adminDeleteSpec("cluster_agent_delete", ownerClusterAgents, toolutil.DestructiveVoidAction(client, clusteragents.DeleteAgent), "gitlab_delete_cluster_agent"),
		adminReadSpec("cluster_agent_token_list", ownerClusterAgents, toolutil.RouteAction(client, clusteragents.ListAgentTokens), "gitlab_list_cluster_agent_tokens"),
		adminReadSpec("cluster_agent_token_get", ownerClusterAgents, toolutil.RouteAction(client, clusteragents.GetAgentToken), "gitlab_get_cluster_agent_token"),
		adminCreateSpec("cluster_agent_token_create", ownerClusterAgents, toolutil.RouteAction(client, clusteragents.CreateAgentToken), "gitlab_create_cluster_agent_token"),
		adminDeleteSpec("cluster_agent_token_revoke", ownerClusterAgents, toolutil.DestructiveVoidAction(client, clusteragents.RevokeAgentToken), "gitlab_revoke_cluster_agent_token"),
		adminDeleteSpec("dependency_proxy_delete", ownerDependencyProxy, toolutil.DestructiveVoidAction(client, dependencyproxy.Purge), "gitlab_purge_dependency_proxy"),
		adminCreateSpec("import_github", ownerImportService, toolutil.RouteAction(client, importservice.ImportFromGitHub), "gitlab_import_from_github"),
		adminUpdateSpec("import_cancel_github", ownerImportService, toolutil.RouteAction(client, importservice.CancelGitHubImport), "gitlab_cancel_github_import"),
		adminCreateSpec("import_gists", ownerImportService, toolutil.RouteVoidAction(client, importservice.ImportGists), "gitlab_import_github_gists"),
		adminCreateSpec("import_bitbucket", ownerImportService, toolutil.RouteAction(client, importservice.ImportFromBitbucketCloud), "gitlab_import_from_bitbucket_cloud"),
		adminCreateSpec("import_bitbucket_server", ownerImportService, toolutil.RouteAction(client, importservice.ImportFromBitbucketServer), "gitlab_import_from_bitbucket_server"),
	}
}

func adminReadSpec(name, owner string, route toolutil.ActionRoute, individualTool string) toolutil.ActionSpec {
	return toolutil.NewReadActionSpec(name, route, adminOptions(owner, individualTool))
}

func adminCreateSpec(name, owner string, route toolutil.ActionRoute, individualTool string) toolutil.ActionSpec {
	return toolutil.NewCreateActionSpec(name, route, adminOptions(owner, individualTool))
}

func adminUpdateSpec(name, owner string, route toolutil.ActionRoute, individualTool string) toolutil.ActionSpec {
	return toolutil.NewUpdateActionSpec(name, route, adminOptions(owner, individualTool))
}

func adminDeleteSpec(name, owner string, route toolutil.ActionRoute, individualTool string) toolutil.ActionSpec {
	return toolutil.NewDeleteActionSpec(name, route, adminOptions(owner, individualTool))
}

func adminUpdateCreateIndividualSpec(name, owner string, route toolutil.ActionRoute, individualTool string) toolutil.ActionSpec {
	individualIdempotent := false
	options := adminOptions(owner, individualTool)
...
func adminDestructiveUpdateIndividualSpec(name, owner string, route toolutil.ActionRoute, individualTool string) toolutil.ActionSpec {
...
func adminSystemHookEditSpec(client *gitlabclient.Client) toolutil.ActionSpec {
	options := adminOptions(ownerSystemHooks, "gitlab_edit_system_hook")
...
func adminSystemHookSetURLVariableSpec(client *gitlabclient.Client) toolutil.ActionSpec {
	options := adminOptions(ownerSystemHooks, "gitlab_set_system_hook_url_variable")
...
func adminSystemHookDeleteURLVariableSpec(client *gitlabclient.Client) toolutil.ActionSpec {
	options := adminOptions(ownerSystemHooks, "gitlab_delete_system_hook_url_variable")
...
func adminTerraformStateUnlockSpec(client *gitlabclient.Client) toolutil.ActionSpec {
	individualDestructive := false
	options := adminOptions(ownerTerraformStates, "gitlab_unlock_terraform_state")
	options.IndividualTool.AnnotationOverrides.Destructive = &individualDestructive
...
// adminOptions builds the shared options for one admin action. The owner is
// the domain package whose handler the action routes to, never this one: see
