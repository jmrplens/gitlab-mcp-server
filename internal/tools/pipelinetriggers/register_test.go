// register_test.go contains integration tests for the pipeline trigger tool
...
// TestRegisterTools_DeleteError verifies that the delete handler closure in register.go
// returns an error result when the GitLab API fails.
...
// branch in the gitlab_pipeline_trigger_delete handler when the user declines.
