...
var eventActionMeta = map[string]eventActionMetaEntry{
	...
	"gitlab_issue_label_event_get": {
		...
		aliases:     []string{"get issue label event", "show issue label change", "fetch issue label event", "view issue label change"},
	...
	"gitlab_mr_label_event_list": {
		...
		aliases:     []string{"list mr label events", "merge request label history", "label changes on mr", "show mr label events"},
	...
	"gitlab_mr_label_event_get": {
		...
		aliases:     []string{"get mr label event", "show merge request label change", "fetch mr label event", "view merge request label change"},
	...
	"gitlab_issue_milestone_event_get": {
		...
		aliases:     []string{"get issue milestone event", "show issue milestone change", "fetch issue milestone event", "view issue milestone change"},
	...
	"gitlab_mr_milestone_event_list": {
		...
		aliases:     []string{"list mr milestone events", "merge request milestone history", "milestone changes on mr", "show mr milestone events"},
	...
	"gitlab_mr_milestone_event_get": {
		...
		aliases:     []string{"get mr milestone event", "show merge request milestone change", "fetch mr milestone event", "view merge request milestone change"},
	...
	"gitlab_issue_state_event_list": {
		...
		aliases:     []string{"list issue state events", "issue state history", "issue close reopen history", "show issue state events"},
	...
	"gitlab_issue_state_event_get": {
		...
		aliases:     []string{"get issue state event", "show issue state change", "fetch issue state event", "view issue state change"},
	...
	"gitlab_mr_state_event_list": {
		...
		aliases:     []string{"list mr state events", "merge request state history", "mr close reopen merge history", "show mr state events"},
	...
	"gitlab_mr_state_event_get": {
		...
		aliases:     []string{"get mr state event", "show merge request state change", "fetch mr state event", "view merge request state change"},
	...
	"gitlab_issue_iteration_event_get": {
		...
		aliases:     []string{"get issue iteration event", "show issue iteration change", "fetch issue iteration event", "view issue iteration change"},
