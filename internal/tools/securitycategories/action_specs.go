...
func securityCategoryCreateSpec(name string, route toolutil.ActionRoute, individualTool, description string) toolutil.ActionSpec {
	...
	options.RelatedActions = []string{"security_category.update", "security_category.delete", "security_attribute.create", actionGroupGet}
...
func securityCategoryOptions(individualTool, description string) toolutil.ActionSpecOptions {
	return toolutil.ActionSpecOptions{
		...
		RelatedActions: []string{"security_attribute.create", "security_attribute.update", actionGroupGet, "project.get"},
		OpenWorld:      true,
		Edition:        "premium",
