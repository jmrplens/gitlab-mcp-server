...
func securityCategoryCreateSpec(name string, route toolutil.ActionRoute, individualTool, description string) toolutil.ActionSpec {
	...
	options.RelatedActions = []string{actionCategoryUpdate, actionCategoryDelete, actionAttributeCreate, actionGroupGet}
...
func securityCategoryUpdateSpec(name string, route toolutil.ActionRoute, individualTool, description string) toolutil.ActionSpec {
	...
	options.RelatedActions = []string{actionCategoryCreate, actionCategoryDelete, actionAttributeUpdate, actionGroupGet}
...
func securityCategoryOptions(individualTool, description string) toolutil.ActionSpecOptions {
	return toolutil.ActionSpecOptions{
		...
		RelatedActions: []string{actionAttributeCreate, actionAttributeUpdate, actionGroupGet, actionProjectGet},
		OpenWorld:      true,
		Edition:        "premium",
