...
func TestCollectedActionSpecs_MigratedMetaToolParity(t *testing.T) {
	...
	for _, toolName := range []string{"gitlab_branch", "gitlab_ci_catalog", "gitlab_ci_variable", "gitlab_custom_emoji", "gitlab_environment", "gitlab_feature_flags", "gitlab_model_registry", "gitlab_project", "gitlab_release", "gitlab_repository", "gitlab_tag", "gitlab_template", "gitlab_wiki"} {
