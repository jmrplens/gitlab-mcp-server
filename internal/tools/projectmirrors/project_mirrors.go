...
func toOutput(m *gl.ProjectMirror) Output {
	...
	if m.LastSuccessfulUpdateAt != nil {
		o.LastSuccessfulUpdateAt = m.LastSuccessfulUpdateAt.Format("2006-01-02T15:04:05Z")
	}
	if m.LastUpdateAt != nil {
		o.LastUpdateAt = m.LastUpdateAt.Format("2006-01-02T15:04:05Z")
	}
	if m.LastUpdateStartedAt != nil {
		o.LastUpdateStartedAt = m.LastUpdateStartedAt.Format("2006-01-02T15:04:05Z")
	}
	if m.HostKeys != nil {
