...
func RegisterMeta(server *mcp.Server, client *gitlabclient.Client) {
	routes := map[string]toolutil.ActionFunc{
		...
		"jobs":                     toolutil.WrapAction(client, ListJobs),
		"list_project":             toolutil.WrapAction(client, ListProject),
		"enable_project":           toolutil.WrapAction(client, EnableProject),
		"disable_project":          toolutil.WrapVoidAction(client, DisableProject),
		"list_group":               toolutil.WrapAction(client, ListGroup),
		"register":                 toolutil.WrapAction(client, Register),
		"delete_registered":        toolutil.WrapVoidAction(client, DeleteByID),
		"delete_by_token":          toolutil.WrapVoidAction(client, DeleteByToken),
		"verify":                   toolutil.WrapVoidAction(client, Verify),
		"reset_token":              toolutil.WrapAction(client, ResetAuthToken),
		"reset_instance_reg_token": toolutil.WrapAction(client, ResetInstanceRegToken),
