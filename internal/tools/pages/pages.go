...
const dateFormatTimestamp = "2006-01-02T15:04:05Z"
...
func toPagesOutput(p *gl.Pages) Output {
	...
	for _, d := range p.Deployments {
		out.Deployments = append(out.Deployments, DeploymentOutput{
			CreatedAt:     d.CreatedAt.Format(dateFormatTimestamp),
			URL:           d.URL,
...
func toDomainOutput(d *gl.PagesDomain) DomainOutput {
	...
	if d.EnabledUntil != nil {
		out.EnabledUntil = d.EnabledUntil.Format(dateFormatTimestamp)
	}
	if d.Certificate.Expiration != nil {
		out.Certificate.Expiration = d.Certificate.Expiration.Format(dateFormatTimestamp)
	}
	return out
}
