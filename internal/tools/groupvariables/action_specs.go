...
func groupVariableOptionsForAction(actionName, individualTool string) toolutil.ActionSpecOptions {
	...
	case "group_get":
		...
		options.RelatedActions = []string{actionGroupVariableList, actionGroupVariableUpdate}
	...
	case "group_create":
		...
		options.RelatedActions = []string{actionGroupVariableList, actionGroupVariableGet, actionGroupVariableUpdate}
		options.ParameterGuidance = map[string]toolutil.ParameterGuidance{
			"key": {
				SemanticRole:   "ci_variable_key",
	...
	case "group_delete":
		...
		options.RelatedActions = []string{actionGroupVariableList, actionGroupVariableGet}
