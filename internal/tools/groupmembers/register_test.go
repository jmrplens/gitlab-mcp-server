...
// TestRegisterTools_DeleteErrors covers the if-err branches after Delete()
// and UnshareGroup() in register.go closures.
...
// branches in the group member remove and unshare handlers when the user declines.
