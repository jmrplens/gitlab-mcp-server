...
var serverManagedRequestOptions = []requestOptionAlias{
	...
	{name: "GITLAB_MCP_TIER", headers: []string{"GITLAB_MCP_TIER", "GITLAB-MCP-TIER", "GITLAB_TIER", "GITLAB-TIER", "TIER"}},
	{name: "GITLAB_MCP_READ_ONLY", headers: []string{"GITLAB_MCP_READ_ONLY", "GITLAB-MCP-READ-ONLY", "GITLAB_READ_ONLY", "GITLAB-READ-ONLY", "READ-ONLY"}},
	{name: "GITLAB_MCP_SAFE_MODE", headers: []string{"GITLAB_MCP_SAFE_MODE", "GITLAB-MCP-SAFE-MODE", "GITLAB_SAFE_MODE", "GITLAB-SAFE-MODE", "SAFE-MODE"}},
	...
	{name: "GITLAB_MCP_IGNORE_SCOPES", headers: []string{"GITLAB_MCP_IGNORE_SCOPES", "GITLAB-MCP-IGNORE-SCOPES", "GITLAB_IGNORE_SCOPES", "GITLAB-IGNORE-SCOPES", "IGNORE-SCOPES"}},
