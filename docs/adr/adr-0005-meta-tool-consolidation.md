...
- `TOOL_SURFACE=individual` exposes the individual catalog projection: 1030 tools on self-managed Enterprise/Premium, or 1036 on GitLab.com Enterprise/Premium with Orbit
