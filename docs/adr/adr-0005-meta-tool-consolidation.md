...
- **POS-001**: Token reduction — from 68 to 33 base tools reduces `tools/list` response by ≈51%
- **POS-002**: Simpler tool selection — LLMs choose among 33 base tools instead of 68
...
- `TOOL_SURFACE=individual` exposes the individual catalog projection: 1027 tools on self-managed Enterprise/Premium, or 1033 on GitLab.com Enterprise/Premium with Orbit
