...
| Metric                                                |  Value |
| ----------------------------------------------------- | -----: |
| Total test functions                                  | 10,241 |
| Unit test functions                                   |  9,990 |
| E2E test functions                                    |    251 |
| cmd test functions                                    |    536 |
...
| Pattern                                | Count |     % |
| -------------------------------------- | ----: | ----: |
| `TestFunc_Scenario` (2-part)           | 9,184 | 89.7% |
| `TestFunc` (no underscore)             |   767 |  7.5% |
...
| ----------------------- | -------------: | ---------: | ----------------------------------------------------------------------------------------------- |
| Core packages           |          1,750 |         85 | shared runtime packages such as config, GitLab client, OAuth, resources, prompts, and utilities |
| Tools orchestration     |            284 |         12 | registration, meta-tool dispatch, safe mode, validation, markdown, and routing tests            |
| Tool sub-packages (171) |          7,420 |        331 | domain-specific GitLab tool handlers                                                            |
| E2E integration         |            251 |        109 | build-tagged real GitLab integration suite                                                      |
| cmd packages            |            536 |         23 | server entry point and developer command utilities                                              |
| **Total**               |     **10,241** |    **560** |                                                                                                 |
...
| resources    |       170 |    95.0% | Package resources registers read-only MCP resources for GitLab and server metadata.                                                                                                                               |
...
- **cmd/eval_mcp_surfaces** (59.5%) - developer command formatting and reporting branches are covered by focused unit tests plus manual/CI tooling runs.
