...
| Metric                                                |  Value |
| ----------------------------------------------------- | -----: |
| Total test functions                                  | 11,562 |
| Unit test functions                                   | 11,280 |
| E2E test functions                                    |    282 |
| cmd test functions                                    |    870 |
...
| Pattern                                |  Count |     % |
| -------------------------------------- | -----: | ----: |
| `TestFunc_Scenario` (2-part)           | 10,301 | 89.1% |
...
| cmd packages            |            870 |         61 | server entry point and developer command utilities                                              |
| **Total**               |     **11,562** |    **653** |                                                                                                 |
