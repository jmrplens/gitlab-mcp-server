...
| Metric                                                |  Value |
| ----------------------------------------------------- | -----: |
| Total test functions                                  | 10,349 |
| Unit test functions                                   | 10,098 |
...
| Pattern                                | Count |     % |
| -------------------------------------- | ----: | ----: |
| `TestFunc_Scenario` (2-part)           | 9,288 | 89.7% |
...
| Tool sub-packages (171) |          7,426 |        331 | domain-specific GitLab tool handlers                                                            |
