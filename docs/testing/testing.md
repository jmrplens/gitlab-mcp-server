...
| Metric                                                |  Value |
| ----------------------------------------------------- | -----: |
| Total test functions                                  | 10,924 |
| Unit test functions                                   | 10,643 |
...
| Pattern                                | Count |     % |
| -------------------------------------- | ----: | ----: |
| `TestFunc_Scenario` (2-part)           | 9,773 | 89.5% |
...
| Tool sub-packages (175) |          7,672 |        343 | domain-specific GitLab tool handlers                                                            |
