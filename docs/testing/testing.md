...
| Metric | Value |
| --- | ---: |
| Total test functions | 10,112 |
| Unit test functions | 9,861 |
...
| Pattern | Count | % |
| --- | ---: | ---: |
| `TestFunc_Scenario` (2-part) | 9,077 | 89.8% |
...
| --- | ---: | ---: | --- |
| Core packages | 1,697 | 78 | shared runtime packages such as config, GitLab client, OAuth, resources, prompts, and utilities |
| Tools orchestration | 284 | 12 | registration, meta-tool dispatch, safe mode, validation, markdown, and routing tests |
| Tool sub-packages (170) | 7,369 | 328 | domain-specific GitLab tool handlers |
...
| toolutil | 436 | 96.7% | Package toolutil provides shared utilities for MCP tool handler sub-packages. |
...
| securityattributes | 21 | 1 | 98.0% | 5 |
| securitycategories | 14 | 1 | 97.9% | 3 |
...
| search | 100.0% |
| securefiles | 98.8% |
| securityattributes | 98.0% |
| securitycategories | 97.9% |
