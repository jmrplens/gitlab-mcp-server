...
| Metric                                                |  Value |
| ----------------------------------------------------- | -----: |
| Total test functions                                  | 10,404 |
| Unit test functions                                   | 10,151 |
...
| Pattern                                | Count |     % |
| -------------------------------------- | ----: | ----: |
| `TestFunc_Scenario` (2-part)           | 9,324 | 89.6% |
...
| Tool sub-packages (175) |          7,459 |        335 | domain-specific GitLab tool handlers                                                            |
