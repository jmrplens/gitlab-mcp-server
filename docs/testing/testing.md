...
| Metric                                                |  Value |
| ----------------------------------------------------- | -----: |
| Total test functions                                  | 10,399 |
| Unit test functions                                   | 10,146 |
...
| Pattern                                | Count |     % |
| -------------------------------------- | ----: | ----: |
| `TestFunc_Scenario` (2-part)           | 9,319 | 89.6% |
...
| Tool sub-packages (175) |          7,454 |        335 | domain-specific GitLab tool handlers                                                            |
