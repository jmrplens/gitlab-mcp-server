...
| Metric                                                |  Value |
| ----------------------------------------------------- | -----: |
| Total test functions                                  | 10,143 |
| Unit test functions                                   |  9,892 |
...
| Pattern                                | Count |     % |
| -------------------------------------- | ----: | ----: |
| `TestFunc_Scenario` (2-part)           | 9,092 | 89.6% |
| `TestFunc` (no underscore)             |   765 |  7.5% |
| `TestFunc_Scenario_Expected` (3+ part) |   286 |  2.8% |
...
| ----------------------- | -------------: | ---------: | ----------------------------------------------------------------------------------------------- |
| Core packages           |          1,717 |         79 | shared runtime packages such as config, GitLab client, OAuth, resources, prompts, and utilities |
...
| docgen       |         2 |    97.8% | Package docgen contains helpers for generated project documentation.                                                                                                                                              |
...
- **cmd/gen_readme** (37.4%) - developer command formatting and reporting branches are covered by focused unit tests plus manual/CI tooling runs.
