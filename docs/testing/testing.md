...
| Metric | Value |
| --- | ---: |
| Total test functions | 9,446 |
| Unit test functions | 9,201 |
...
| Pattern | Count | % |
| --- | ---: | ---: |
| `TestFunc_Scenario` (2-part) | 8,470 | 89.7% |
| `TestFunc` (no underscore) | 704 | 7.5% |
...
| Tool sub-packages (164) | 7,057 | 312 | domain-specific GitLab tool handlers |
