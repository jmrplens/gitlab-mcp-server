...
| Individual tools         | 866 Free/CE / 1020 Premium / 1086 Ultimate / 1092 GitLab.com Ultimate with Orbit | Clients that benefit from one tool per GitLab operation                |
...
- [Environment Variable Reference](../reference/env.md)
- [CLI Reference](../reference/cli.md)
- [Architecture Overview](architecture.md)
- [AI Model Evaluation](../development/testing/model-evaluation.md)
