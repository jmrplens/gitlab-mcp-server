...
| File            | Purpose                                                                                                                                                                                                                                                                                                                                                                          |
| --------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `pool.go`       | `ServerPool` with LRU eviction, `Entry`, `GetOrCreateEntry()`, `GetOrCreate()`, `GetOrCreateWithScopes()`, `Close()`; narrows an entry to read-only when its token cannot write. Both eviction paths ask `WithInUse` whether an entry is busy: the idle sweep skips a busy entry outright, and size pressure prefers an unbusy one and takes a busy one only when every entry is |
