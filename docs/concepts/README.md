...
Capacity planning lives with the measurements it comes from, in
[Resource Consumption](../reference/resource-consumption.md) beside the
[Resource Benchmark](../reference/resource-benchmark.md).
