...
With `TOOL_SURFACE=meta`, the 22 individual tools below are consolidated into two meta-tools: `gitlab_runner` (18 actions) and `gitlab_resource_group` (4 actions).
