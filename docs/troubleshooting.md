...
| No "Next steps" in response | Tool is used in individual mode (not meta-tool) | Next steps appear in meta-tool mode (`TOOL_SURFACE=meta`, default). Individual tools include hints in Markdown content only |
