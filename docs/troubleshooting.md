...
| Symptom | Cause | Solution |
| --- | --- | --- |
| MCP client shows 1005 tools instead of 28 | Meta-tools disabled | Set `META_TOOLS=true` (default) to use 28 domain meta-tools instead of 1005 individual tools |
