...
| Symptom                                                     | Cause                                          | Solution                                                                                                                                                                                                                                                                                                                                                                                                          |
| ----------------------------------------------------------- | ---------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| MCP client shows hundreds of individual tools instead of 33 | Individual surface selected                    | Set `TOOL_SURFACE=meta` to use 32 base meta-tools, 48 self-managed enterprise meta-tools, or 49 GitLab.com Enterprise meta-tools instead of the individual catalog                                                                                                                                                                                                                                                |
