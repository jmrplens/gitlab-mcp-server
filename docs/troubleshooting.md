...
| Symptom | Cause | Solution |
| --- | --- | --- |
| MCP client shows 1006 tools instead of 42 | Meta-tools disabled | Set `META_TOOLS=true` (default) to use 42 domain meta-tools instead of 1006 individual tools |
