...
| ------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [Installation](installation.md)                         | Install through any channel (binary, Homebrew, winget, Docker, npm, PyPI, `.mcpb`, Agent Plugins, hosted endpoint), then verify, upgrade or uninstall it |
