...
| `--yolo-mode`                   | `false`        | Skip the confirmation prompt on destructive actions. Sets `YOLO_MODE`                                                                                                                                                                                                                 |
