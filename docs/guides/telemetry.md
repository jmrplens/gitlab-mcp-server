...
| `rejected_credential` | GitLab refused the credential on a call: a `401` naming the token, or a `401` the credential probe then confirmed, never a permission refusal ([Refused calls](http-server-mode.md#refused-calls)) |
