...
> 📖 **User documentation**: See the [Auto-update](https://jmrp.io/docs/gitlab-mcp-server/operations/auto-update/) on the documentation site for a user-friendly version.
