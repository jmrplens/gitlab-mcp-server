...
| `make check-api-exposes`            | Fail when the committed record of the conditions GitLab sends each REST entity field under cannot be read, is too short to be GitLab's whole entity tree, lacks provenance, or is older than 180 days                                                                                                                                                                                                                                                                               |
