...
| Metric                                                |  Value |
| ----------------------------------------------------- | -----: |
| Total test functions                                  | 14,741 |
| Unit test functions                                   | 14,138 |
| E2E test functions                                    |    603 |
| cmd test functions                                    |  2,820 |
...
| Pattern                                |  Count |     % |
| -------------------------------------- | -----: | ----: |
| `TestFunc_Scenario` (2-part)           | 11,836 | 80.3% |
...
| cmd packages            |          2,820 |        191 | server entry point and developer command utilities                                              |
| **Total**               |     **14,741** |    **949** |                                                                                                 |
...
| testutil      |        74 |    95.1% | Package testutil provides test helpers for gitlab-mcp-server.                                                                                                                                                                                                      |
