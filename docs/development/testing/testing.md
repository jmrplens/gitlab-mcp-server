...
| Metric                                                |  Value |
| ----------------------------------------------------- | -----: |
| Total test functions                                  | 14,161 |
| Unit test functions                                   | 13,563 |
| E2E test functions                                    |    598 |
| cmd test functions                                    |  2,488 |
...
| Pattern                                |  Count |     % |
| -------------------------------------- | -----: | ----: |
| `TestFunc_Scenario` (2-part)           | 11,606 | 82.0% |
...
| cmd packages            |          2,488 |        150 | server entry point and developer command utilities                                              |
| **Total**               |     **14,161** |    **891** |                                                                                                 |
