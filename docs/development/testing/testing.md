...
| Pattern                                |  Count |     % |
| -------------------------------------- | -----: | ----: |
| `TestFunc_Scenario` (2-part)           | 11,907 | 79.1% |
| `TestFunc` (no underscore)             |    975 |  6.5% |
| `TestFunc_Scenario_Expected` (3+ part) |  2,174 | 14.4% |
...
| cmd packages            |          3,002 |        208 | server entry point and developer command utilities                                              |
| **Total**               |     **15,056** |    **971** |                                                                                                 |
