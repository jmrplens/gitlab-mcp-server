...
| Metric                                                |  Value |
| ----------------------------------------------------- | -----: |
| Total test functions                                  | 19,210 |
| Unit test functions                                   | 17,865 |
| E2E test functions                                    |  1,345 |
| cmd test functions                                    |  3,818 |
...
| `TestFunc_Scenario_Expected` (3+ part) |  5,641 | 29.4% |
...
| cmd packages            |          3,818 |        245 | server entry point and developer command utilities                                              |
| **Total**               |     **19,210** |  **1,302** |                                                                                                 |
