...
| Metric                                                |  Value |
| ----------------------------------------------------- | -----: |
| Total test functions                                  | 13,613 |
| Unit test functions                                   | 13,047 |
| E2E test functions                                    |    566 |
| cmd test functions                                    |  2,121 |
...
| Pattern                                |  Count |     % |
| -------------------------------------- | -----: | ----: |
| `TestFunc_Scenario` (2-part)           | 11,299 | 83.0% |
| `TestFunc` (no underscore)             |    968 |  7.1% |
| `TestFunc_Scenario_Expected` (3+ part) |  1,346 |  9.9% |
...
| cmd packages            |          2,121 |        130 | server entry point and developer command utilities                                              |
| **Total**               |     **13,613** |    **850** |                                                                                                 |
