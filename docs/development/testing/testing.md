...
| Metric                                                |  Value |
| ----------------------------------------------------- | -----: |
| Total test functions                                  | 11,961 |
| Unit test functions                                   | 11,589 |
...
| Pattern                                |  Count |     % |
| -------------------------------------- | -----: | ----: |
| `TestFunc_Scenario` (2-part)           | 10,584 | 88.5% |
...
| Tool sub-packages (175) |          8,328 |        349 | domain-specific GitLab tool handlers                                                            |
...
| cmd/audit_1to1/internal/structs                |    95.8% |
