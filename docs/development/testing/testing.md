...
| Metric                                                |  Value |
| ----------------------------------------------------- | -----: |
| Total test functions                                  | 16,594 |
| Unit test functions                                   | 15,394 |
| E2E test functions                                    |  1,200 |
| cmd test functions                                    |  3,211 |
...
| Pattern                                |  Count |     % |
| -------------------------------------- | -----: | ----: |
| `TestFunc_Scenario` (2-part)           | 12,498 | 75.3% |
| `TestFunc` (no underscore)             |    942 |  5.7% |
| `TestFunc_Scenario_Expected` (3+ part) |  3,154 | 19.0% |
...
| ----------------------- | -------------: | ---------: | ----------------------------------------------------------------------------------------------- |
| Core packages           |          2,720 |        162 | shared runtime packages such as config, GitLab client, OAuth, resources, prompts, and utilities |
...
| cmd packages            |          3,211 |        224 | server entry point and developer command utilities                                              |
| **Total**               |     **16,594** |  **1,241** |                                                                                                 |
