...
| Metric                                                |  Value |
| ----------------------------------------------------- | -----: |
| Total test functions                                  | 12,473 |
| Unit test functions                                   | 12,092 |
| E2E test functions                                    |    381 |
| cmd test functions                                    |  1,144 |
...
| Pattern                                |  Count |     % |
| -------------------------------------- | -----: | ----: |
| `TestFunc_Scenario` (2-part)           | 10,802 | 86.6% |
...
| cmd packages            |          1,144 |         83 | server entry point and developer command utilities                                              |
| **Total**               |     **12,473** |    **732** |                                                                                                 |
...
| toolutil      |       731 |    97.7% | Package toolutil provides shared utilities for MCP tool handler sub-packages.                                                                                                                                     |
...
- **cmd/server** (86.6%) - entry-point glue, signal handling, and transport startup are validated mostly through integration and E2E coverage.
