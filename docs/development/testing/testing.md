...
| Unit test functions                                   | 15,395 |
| E2E test functions                                    |    910 |
| cmd test functions                                    |  3,202 |
...
| Pattern                                |  Count |     % |
| -------------------------------------- | -----: | ----: |
| `TestFunc_Scenario` (2-part)           | 12,176 | 74.7% |
...
| cmd packages            |          3,202 |        228 | server entry point and developer command utilities                                              |
| **Total**               |     **16,305** |  **1,116** |                                                                                                 |
