...
| Metric                                                |  Value |
| ----------------------------------------------------- | -----: |
| Total test functions                                  | 19,208 |
| Unit test functions                                   | 17,863 |
| E2E test functions                                    |  1,345 |
| cmd test functions                                    |  3,816 |
...
| `TestFunc_Scenario_Expected` (3+ part) |  5,639 | 29.4% |
...
| cmd packages            |          3,816 |        245 | server entry point and developer command utilities                                              |
| **Total**               |     **19,208** |  **1,302** |                                                                                                 |
