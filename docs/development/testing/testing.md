...
| Metric                                                |  Value |
| ----------------------------------------------------- | -----: |
| Total test functions                                  | 15,081 |
| Unit test functions                                   | 14,476 |
| E2E test functions                                    |    605 |
| cmd test functions                                    |  3,027 |
...
| Pattern                                |  Count |     % |
| -------------------------------------- | -----: | ----: |
| `TestFunc_Scenario` (2-part)           | 11,910 | 79.0% |
| `TestFunc` (no underscore)             |    975 |  6.5% |
| `TestFunc_Scenario_Expected` (3+ part) |  2,196 | 14.6% |
...
| cmd packages            |          3,027 |        211 | server entry point and developer command utilities                                              |
| **Total**               |     **15,081** |    **974** |                                                                                                 |
