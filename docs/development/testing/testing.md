...
| Metric                                                |  Value |
| ----------------------------------------------------- | -----: |
| Total test functions                                  | 14,341 |
| Unit test functions                                   | 13,740 |
| E2E test functions                                    |    601 |
| cmd test functions                                    |  2,555 |
...
| Pattern                                |  Count |     % |
| -------------------------------------- | -----: | ----: |
| `TestFunc_Scenario` (2-part)           | 11,750 | 81.9% |
| `TestFunc` (no underscore)             |    976 |  6.8% |
| `TestFunc_Scenario_Expected` (3+ part) |  1,615 | 11.3% |
...
| cmd packages            |          2,555 |        154 | server entry point and developer command utilities                                              |
| **Total**               |     **14,341** |    **902** |                                                                                                 |
