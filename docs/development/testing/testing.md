...
| Metric                                                |  Value |
| ----------------------------------------------------- | -----: |
| Total test functions                                  | 14,334 |
| Unit test functions                                   | 13,732 |
| E2E test functions                                    |    602 |
| cmd test functions                                    |  2,523 |
...
| Pattern                                |  Count |     % |
| -------------------------------------- | -----: | ----: |
| `TestFunc_Scenario` (2-part)           | 11,740 | 81.9% |
| `TestFunc` (no underscore)             |    976 |  6.8% |
| `TestFunc_Scenario_Expected` (3+ part) |  1,618 | 11.3% |
...
| ----------------------- | -------------: | ---------: | ----------------------------------------------------------------------------------------------- |
| Core packages           |          2,354 |        139 | shared runtime packages such as config, GitLab client, OAuth, resources, prompts, and utilities |
...
| cmd packages            |          2,523 |        152 | server entry point and developer command utilities                                              |
| **Total**               |     **14,334** |    **901** |                                                                                                 |
...
| mcpotel       |        87 |    99.0% | Package mcpotel instruments MCP request handling with OpenTelemetry.                                                                                                                                                                                               |
...
| subscriptions |        98 |    98.5% | Package subscriptions implements MCP resource subscriptions (resources/subscribe) over GitLab resources.                                                                                                                                                           |
