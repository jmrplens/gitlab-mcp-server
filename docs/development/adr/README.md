...
- YAML front matter (title, status, date, authors, tags). ADR-0010 and ADR-0015 through ADR-0021 carry none and state their status and date in the Status section instead
