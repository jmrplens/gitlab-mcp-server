...
| Metric | Value |
| --- | ---: |
| Total test functions | 9,125 |
| Unit test functions | 8,883 |
| E2E test functions | 242 |
| cmd test functions | 163 |
...
| Pattern | Count | % |
| --- | ---: | ---: |
| `TestFunc_Scenario` (2-part) | 8,203 | 89.9% |
...
| cmd packages | 163 | 10 | server entry point and developer command utilities |
| **Total** | **9,125** | **515** |  |
...
- **cmd/eval_meta_tools** (59.7%) - developer command formatting and reporting branches are covered by focused unit tests plus manual/CI tooling runs.
