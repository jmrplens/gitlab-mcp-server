...
Meta-tool tests verify the action-dispatch layer that consolidates 1006 individual tools into 42 base / 57 enterprise domain meta-tools. These tests live in `internal/tools/` (the orchestration package).
