...
| Metric | Value |
| --- | ---: |
| Total test functions | 9,126 |
| Unit test functions | 8,884 |
| E2E test functions | 242 |
| cmd test functions | 164 |
...
| Pattern | Count | % |
| --- | ---: | ---: |
| `TestFunc_Scenario` (2-part) | 8,204 | 89.9% |
...
| cmd packages | 164 | 10 | server entry point and developer command utilities |
| **Total** | **9,126** | **515** |  |
...
- **cmd/eval_meta_tools** (60.0%) - developer command formatting and reporting branches are covered by focused unit tests plus manual/CI tooling runs.
