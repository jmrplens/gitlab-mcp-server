...
| `audit_md_escaping`            | Source quality audits         | Values a Markdown formatter interpolates into a table cell, heading, list item or link without an escaping helper, or into a code fence it wrote by hand                                                                                       | `make check-md-escaping`                                                            |
...
| `-dir`             | string | `.`     | Repository root to audit                                                                                                                 |
| `-json`            | string | _(off)_ | Write the JSON work list to this path                                                                                                    |
| `-contexts`        | string | `all`   | Constructs to judge: `all`, or a comma-separated list of `fence`, `heading`, `link-destination`, `link-label`, `list-item`, `table-cell` |
...
| `check-md-escaping`                      | `audit_md_escaping -check`         | No value reaches a Markdown table cell, heading, list item or link unescaped, and none lands inside a hand-written code fence | Non-zero on a finding or a directive that excuses nothing                                                                                                        |
