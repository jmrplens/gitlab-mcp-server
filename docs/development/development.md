...
Meta-tool counts are additive: 34 base tools, 17 Premium/Ultimate-specific meta-tools for 51 on self-managed GitLab, plus the GitLab.com-only Orbit meta-tool for 52 when Orbit is available.
