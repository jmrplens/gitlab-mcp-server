...
│   │   ├── register_meta.go     # RegisterAllMeta() — 24 inline + 3 delegated + 1 standalone = 28 meta-tools (43 with GITLAB_ENTERPRISE=true)
...
4. **Meta-tools** optionally group 1000 base tools into 28 domain meta-tools (43 with GITLAB_ENTERPRISE=true) (via ADR-0005)
