...
| `--http-idle-timeout`    | `120s`       | HTTP server idle connection timeout; `0` disables idle connection closure entirely, making `--session-timeout` the effective session lifetime                                         |
