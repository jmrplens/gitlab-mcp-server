...
- [Logging](#logging)
  ...
  - [Real-World Examples](#real-world-examples)
    - [Monitoring Tool Performance](#monitoring-tool-performance)
    - [Diagnosing API Errors](#diagnosing-api-errors)
  - [Frequently Asked Questions](#frequently-asked-questions)
    - [Is logging always active?](#is-logging-always-active)
    - [Can logging slow down tool execution?](#can-logging-slow-down-tool-execution)
    - [Where do I see the logs?](#where-do-i-see-the-logs)
...
This means **every single tool call** (up to 1033 individual tools on GitLab.com Enterprise/Premium) generates a structured log entry with the tool name, execution duration, and success or failure status — with zero manual instrumentation per tool.
