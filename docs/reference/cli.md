...
| `-pool-idle-timeout`      | duration | `1h`                       | Reclaim a pooled per-token server after this long unused; `0` keeps entries until the pool size bound evicts them (upper bound: 24h)                                                                                                                                                          |
