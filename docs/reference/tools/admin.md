...
> **Individual tools**: 75
> **Meta-tool**: `gitlab_admin` (`GITLAB_MCP_TOOL_SURFACE=meta` catalog) — one tool for the whole domain, Terraform states, cluster agents and the dependency proxy included
