...
| `base_access_level` | int    |   Yes    | Base access level (10=Guest, 15=Planner, 20=Reporter, 25=Security Manager, 30=Developer, 40=Maintainer, 50=Owner; 0, 5=Minimal access and 60=Admin are not valid) |
