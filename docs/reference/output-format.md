...
- [Architecture — Response Format](../concepts/architecture.md#design-patterns) — implementation patterns for dual-output
- [Meta-Tools](../concepts/meta-tools.md) — how domain meta-tools use this format
- [Tools Reference](tools/README.md) — per-domain tool documentation
- [Troubleshooting](../guides/troubleshooting.md) — common output format issues
