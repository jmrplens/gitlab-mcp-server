...
| `GITLAB_MCP_RATE_LIMIT_RPS`    | `0`       | Per-server `tools/call` rate limit in requests/second. `0` disables the limiter (default). See [Security — Rate Limiting Model](../concepts/security.md#rate-limiting-model)                                                                           |
