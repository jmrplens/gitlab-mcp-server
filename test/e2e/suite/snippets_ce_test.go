...
// snippets_ce_test.go tests the snippet MCP tools against a live GitLab instance.
...
func TestIndividual_Snippets(t *testing.T) {
	...
	t.Run("Create", func(t *testing.T) {
		...
		requireTruef(t, out.Title == "E2E Test Snippet", "expected title")
		snippetID = out.ID
	...
	t.Run("Get", func(t *testing.T) {
		...
		requireTruef(t, out.ID == snippetID, "expected ID %d, got %d", snippetID, out.ID)
	...
	t.Run("Content", func(t *testing.T) {
		...
		requireTruef(t, out.Content != "", "expected non-empty content")
	...
	t.Run("List", func(t *testing.T) {
		...
		requireTruef(t, len(out.Snippets) >= 1, "expected at least 1 snippet, got %d", len(out.Snippets))
	...
	t.Run("Update", func(t *testing.T) {
		...
		requireTruef(t, out.Title == "E2E Updated Snippet", "expected updated title")
...
func TestMeta_Snippets(t *testing.T) {
	...
	t.Run("Create", func(t *testing.T) {
		...
		requireTruef(t, out.Title == "E2E Meta Snippet", "expected title")
		snippetID = out.ID
	...
	t.Run("Get", func(t *testing.T) {
		...
		requireTruef(t, out.ID == snippetID, "expected ID %d", snippetID)
	...
	t.Run("List", func(t *testing.T) {
		...
		requireTruef(t, len(out.Snippets) >= 1, "expected at least 1 snippet")
	...
	t.Run("Update", func(t *testing.T) {
		...
		requireTruef(t, out.Title == "E2E Meta Updated", "expected updated title")
