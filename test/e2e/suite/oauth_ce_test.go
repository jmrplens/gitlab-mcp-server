...
func testOAuthIdentityPropagation(t *testing.T, cfg e2eOAuthConfig) {
	...
	mcp.AddTool(server, &mcp.Tool{Name: "oauth_identity_probe"}, func(ctx context.Context, req *mcp.CallToolRequest, _ ProbeInput) (*mcp.CallToolResult, ProbeOutput, error) {
