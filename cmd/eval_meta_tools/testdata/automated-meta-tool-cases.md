...
| MT-055 | Archive project `my-org/tools/gitlab-mcp-server`. | `gitlab_project` / `archive` | `project_id` | `confirm` | Yes | Project archived state is returned after confirmation. |
