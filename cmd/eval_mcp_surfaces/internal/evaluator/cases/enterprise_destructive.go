...
func enterpriseDestructiveEvalCases() []Case {
	return []Case{
		...
		baseEnterpriseDestructiveEvalCase("MT-147", "Unprotect branch pattern `release/*` for group `my-org`.", destructiveStep("gitlab", "group.protected_branch_unprotect", params("group_id", "branch"), params("confirm"))),
		baseEnterpriseDestructiveEvalCase("MT-149", "Unprotect group environment `production` for group `my-org`.", destructiveStep("gitlab", "group.protected_env_unprotect", params("group_id", "environment"), params("confirm"))),
