...
func enterpriseDestructiveEvalCases() []EvalCase {
	return []EvalCase{
		...
		baseEnterpriseDestructiveEvalCase("MS-052", "Exercise group protected environment lifecycle with a temporary group: create group `eval-enterprise-protected-env`, protect environment `staging`, list group protected environments, fetch environment `staging`, update it to require one approval, unprotect environment `staging`, then delete the temporary group.",
		...
		baseEnterpriseDestructiveEvalCase("MS-053", "Exercise project protected environment lifecycle with a temporary project: create project `eval-enterprise-protected-env-project`, protect environment `staging`, list protected environments, fetch environment `staging`, unprotect environment `staging`, then delete the temporary project.",
